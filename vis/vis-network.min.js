...
!
function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("vis-data/peer/umd/vis-data.js")) : "function" == typeof define && define.amd ? define(["exports", "vis-data/peer/umd/vis-data.js"], e) : e((t = "undefined" != typeof globalThis ? globalThis: t || self).vis = t.vis || {},
    t.vis)
} (this, (function(t, e) {
    ...
    r = n("object" == typeof globalThis && globalThis) || n("object" == typeof window && window) || n("object" == typeof self && self) || n("object" == typeof i && i) ||
    function() {
        return this
    ...
    M = function(t, e) {
        var i = P[D(t)];
        return i == z || i != I && ("function" == typeof e ? s(e) : !!e)
    },
    ...
    L = {
        f: a ? j: function(t, e, i) {
            if (R(t), e = b(e, !0), R(i), O) try {
                return j(t, e, i)
            } catch(t) {}
    ...
    q = function(t, e) {
        var i, o, n, s, a, h, d, l, c = t.target,
        u = t.global,
        f = t.stat,
        p = t.proto,
        v = u ? r: f ? r[c] : (r[c] || {}).prototype,
        g = u ? F: F[c] || (F[c] = {}),
        y = g.prototype;
        for (n in e) i = !B(u ? n: c + (f ? ".": "#") + n, t.forced) && v && k(v, n),
        a = g[n],
        i && (h = t.noTargetGet ? (l = W(v, n)) && l.value: v[n]),
        s = i && h ? h: e[n],
        i && typeof a == typeof s || (d = t.bind && i ? A(s, r) : t.wrap && i ? V(s) : p && "function" == typeof s ? A(Function.call, s) : s, (t.sham || s && s.sham || a && a.sham) && H(d, "sham", !0), g[n] = d, p && (k(F, o = c + "Prototype") || H(F, o, {}), F[o][n] = s, t.real && y && !y[n] && H(y, n, s)))
    },
    U = [].slice,
    Y = {},
    X = function(t, e, i) {
    ...
    function(t) {
        ...
        return m(e.prototype) && (o.prototype = e.prototype),
        o
    };
    q({
        target: "Function",
    ...
    Q = function(t) {
        var e = t.bind;
        return t === Z || t instanceof Function && e === Z.bind ? $: e
    },
    J = Math.ceil,
    tt = Math.floor,
    et = function(t) {
    ...
    var bt = F.Object.assign;
    function wt(t, e, i, o) {
        t.beginPath(),
        t.arc(e, i, o, 0, 2 * Math.PI, !1),
        t.closePath()
    }
    function kt(t, e, i, o, n, r) {
        var s = Math.PI / 180;
        o - 2 * r < 0 && (r = o / 2),
        n - 2 * r < 0 && (r = n / 2),
        t.beginPath(),
        t.moveTo(e + r, i),
        t.lineTo(e + o - r, i),
        t.arc(e + o - r, i + r, r, 270 * s, 360 * s, !1),
        t.lineTo(e + o, i + n - r),
        t.arc(e + o - r, i + n - r, r, 0, 90 * s, !1),
        t.lineTo(e + r, i + n),
        t.arc(e + r, i + n - r, r, 90 * s, 180 * s, !1),
        t.lineTo(e, i + r),
    ...
    function _t(t, e, i, o, n) {
        ...
        t.beginPath(),
        t.moveTo(e, c),
        t.bezierCurveTo(e, c - a, l - s, i, l, i),
        t.bezierCurveTo(l + s, i, h, c - a, h, c),
        t.bezierCurveTo(h, c + a, l + s, d, l, d),
        t.bezierCurveTo(l - s, d, e, c + a, e, c),
        t.closePath()
    }
    function xt(t, e, i, o, n) {
        ...
        t.beginPath(),
        t.moveTo(d, u),
        t.bezierCurveTo(d, u + h, c + a, l, c, l),
        t.bezierCurveTo(c - a, l, e, u + h, e, u),
        t.bezierCurveTo(e, u - h, c - a, i, c, i),
        t.bezierCurveTo(c + a, i, d, u - h, d, u),
        t.lineTo(d, f),
        t.bezierCurveTo(d, f + h, c + a, p, c, p),
        t.bezierCurveTo(c - a, p, e, f + h, e, f),
        t.lineTo(e, u)
    }
    function Et(t, e, i, o, n, r) {
        t.beginPath(),
        t.moveTo(e, i);
        for (var s = r.length,
        a = o - e,
        h = n - i,
        d = h / a,
        l = Math.sqrt(a * a + h * h), c = 0, u = !0, f = 0, p = +r[0]; l >= .1;)(p = +r[c++%s]) > l && (p = l),
    ...
    },
    {
        getOwnPropertyDescriptors: function(t) {
            for (var e, i, o = y(t), n = S.f, r = Ft(o), s = {},
            a = 0; r.length > a;) void 0 !== (i = n(o, e = r[a++])) && Nt(s, e, i);
            return s
        }
    });
    var At = F.Object.getOwnPropertyDescriptors,
    Rt = S.f,
    jt = s((function() {
        Rt(1)
    }));
    ...
    Wt = Ht,
    Vt = !!Object.getOwnPropertySymbols && !s((function() {
        return ! String(Symbol())
    })),
    qt = Vt && !Symbol.sham && "symbol" == typeof Symbol.iterator,
    Ut = Array.isArray ||
    function(t) {
        return "Array" == f(t)
    },
    Yt = It("document", "documentElement"),
    ...
    Kt = o((function(t) { (t.exports = function(t, e) {
    ...
    Zt = Math.random(),
    Qt = function(t) {
        return "Symbol(" + String(void 0 === t ? "": t) + ")_" + (++$t + Zt).toString(36)
    },
    Jt = Kt("keys"),
    te = function(t) {
        return Jt[t] || (Jt[t] = Qt(t))
    },
    ee = te("IE_PROTO"),
    ie = function() {},
    oe = function(t) {
    ...
    ne = function() {
        ...
        function(t) {
            ...
            return t = null,
            e
        } (Lt) : ((e = E("iframe")).style.display = "none", Yt.appendChild(e), e.src = String("javascript:"), (t = e.contentWindow.document).open(), t.write(oe("document.F=Object")), t.close(), t.F);
        for (var i = ut.length; i--;) delete ne.prototype[ut[i]];
        return ne()
    };
    dt[ee] = !0;
    ...
    function(t, e) {
        var i;
        return null !== t ? (ie.prototype = R(t), i = new ie, ie.prototype = null, i[ee] = t) : i = ne(),
        void 0 === e ? i: Mt(i, e)
    },
    se = Bt.f,
    ae = {}.toString,
    ...
    de = {
        f: function(t) {
            return he && "[object Window]" == ae.call(t) ?
            function(t) {
                try {
                    return se(t)
                } catch(t) {
    ...
    ce = Kt("wks"),
    ue = r.Symbol,
    fe = qt ? ue: ue && ue.withoutSetter || Qt,
    pe = function(t) {
    ...
    var Te, Me, De, Pe = Gt.inspectSource,
    Ie = r.WeakMap,
    ze = "function" == typeof Ie && /native code/.test(Pe(Ie)),
    Be = r.WeakMap;
    if (ze) {
        var Fe = Gt.state || (Gt.state = new Be),
        Ne = Fe.get,
        Ae = Fe.has,
        Re = Fe.set;
        Te = function(t, e) {
    ...
    qe = function(t) {
        ...
        return function(h, d, l, c) {
            for (var u, f, p = vt(h), g = v(p), y = A(d, l, 3), m = ot(g.length), b = 0, w = c || We, k = e ? w(h, m) : i || s ? w(h, 0) : void 0; m > b; b++) if ((a || b in g) && (f = y(u = g[b], b, p), t)) if (e) k[b] = f;
            else if (f) switch (t) {
            case 3:
                return ! 0;
            case 5:
    ...
    ri = Kt("symbols"),
    si = Kt("op-symbols"),
    ai = Kt("string-to-symbol-registry"),
    hi = Kt("symbol-to-string-registry"),
    di = Kt("wks"),
    li = r.QObject,
    ...
    vi = function(t, e, i) {
        ...
        var o = b(e, !0);
        return R(i),
        k(ri, o) ? (i.enumerable ? (k(t, Xe) && t[Xe][o] && (t[Xe][o] = !1), i = re(i, {
            enumerable: c(0, !1)
    ...
    yi = function(t) {
        var e = b(t, !0),
        i = ni.call(this, e);
        return ! (this === Qe && k(ri, e) && !k(si, e)) && (!(i || !k(this, e) || !k(ri, e) || k(this, Xe) && this[Xe][e]) || i)
    },
    mi = function(t, e) {
        var i = y(t),
        o = b(e, !0);
        if (i !== Qe || !k(ri, o) || k(si, o)) {
            var n = ei(i, o);
    ...
    wi = function(t) {
        ...
        i = oi(e ? si: y(t)),
        o = [];
        return Ye(i, (function(t) { ! k(ri, t) || e && !k(Qe, t) || o.push(ri[t])
        })),
        o
    };
    if (Vt || (le((Je = function() {
        if (this instanceof Je) throw TypeError("Symbol is not a constructor");
        var t = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0,
        e = Qt(t),
        i = function(t) {
            this === Qe && i.call(si, t),
            k(this, Xe) && k(this[Xe], e) && (this[Xe][e] = !1),
            ui(this, e, c(1, t))
        };
        return a && ci && ui(Qe, e, {
            configurable: !0,
        ...
        return Ze(this).tag
    })), le(Je, "withoutSetter", (function(t) {
        return fi(Qt(t), t)
    })), l.f = yi, L.f = vi, S.f = mi, Bt.f = de.f = bi, pt.f = wi, ve.f = function(t) {
        return fi(pe(t), t)
    },
    a && ii(Je.prototype, "description", {
        configurable: !0,
        get: function() {
    ...
    },
    {
        ...
        },
        {
            stringify: function(t, e, i) {
                ...
                if (o = e, (m(e) || void 0 !== t) && !pi(t)) return Ut(e) || (e = function(t, e) {
                    if ("function" == typeof o && (e = o.call(this, t, e)), !pi(e)) return e
                }),
                n[1] = e,
                ti.apply(null, n)
            }
    ...
    Je.prototype[Ke] || H(Je.prototype, Ke, Je.prototype.valueOf),
    Ce(Je, Ge),
    dt[Xe] = !0;
    var _i, xi, Ei, Oi = F.Object.getOwnPropertySymbols,
    Ci = {},
    Si = !s((function() {
        function t() {}
    ...
    Ti = te("IE_PROTO"),
    Mi = Object.prototype,
    Di = Si ? Object.getPrototypeOf: function(t) {
        return t = vt(t),
        k(t, Ti) ? t[Ti] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype: t instanceof Object ? Mi: null
    },
    Pi = (pe("iterator"), !1); [].keys && ("next" in (Ei = [].keys()) ? (xi = Di(Di(Ei))) !== Object.prototype && (_i = xi) : Pi = !0),
    null == _i && (_i = {});
    var Ii = {
        IteratorPrototype: _i,
        BUGGY_SAFARI_ITERATORS: Pi
    },
    zi = Ii.IteratorPrototype,
    Bi = function() {
        return this
    },
    Fi = Object.setPrototypeOf || ("__proto__" in {} ?
    function() {
        var t, e = !1,
        i = {};
        try { (t = Object.getOwnPropertyDescriptor(Object.prototype, "__proto__").set).call(i, []),
        ...
        return function(i, o) {
            ...
            e ? t.call(i, o) : i.__proto__ = o,
            i
        }
    } () : void 0),
    Ni = Ii.IteratorPrototype,
    Ai = Ii.BUGGY_SAFARI_ITERATORS,
    Ri = pe("iterator"),
    ji = "keys",
    Li = "values",
    Hi = "entries",
    ...
    Vi = function(t, e, i, o, n, r, s) { !
        ...
        f = !1,
        p = t.prototype,
        v = p[Ri] || p["@@iterator"] || n && p[n],
        g = !Ai && v || l(n),
        y = "Array" == e && p.entries || v;
        if (y && (a = Di(y.call(new t)), Ni !== Object.prototype && a.next && (Ce(a, u, !0, !0), Ci[u] = Wi)), n == Li && v && v.name !== Li && (f = !0, g = function() {
            return v.call(this)
        }), s && p[Ri] !== g && H(p, Ri, g), Ci[e] = g, n) if (h = {
            values: l(Li),
            keys: r ? g: l(ji),
            entries: l(Hi)
        },
        s) for (d in h)(Ai || f || !(d in p)) && le(p, d, h[d]);
        else q({
            target: e,
            proto: !0,
            forced: Ai || f
    ...
    Ci.Arguments = Ci.Array;
    var Xi = pe("toStringTag");
    for (var Gi in {
        CSSRuleList: 0,
    ...
    lo = Array.prototype,
    co = function(t) {
        return void 0 !== t && (Ci.Array === t || lo[ho] === t)
    },
    uo = pe("iterator"),
    fo = !1;
    try {
    ...
    },
    {
        from: function(t) {
            ...
            u = oo(a),
            f = 0;
            if (c && (l = A(l, d > 2 ? arguments[2] : void 0, 2)), null == u || h == Array && co(u)) for (i = new h(e = ot(a.length)); e > f; f++) s = c ? l(a[f], f) : a[f],
            Nt(i, f, s);
            else for (r = (n = u.call(a)).next, i = new h; ! (o = r.call(n)).done; f++) s = c ? ao(n, l, [o.value, f], !0) : o.value,
            Nt(i, f, s);
            return i.length = f,
            i
        }
    ...
    var bo = F.Object,
    wo = function(t, e) {
        return bo.create(t, e)
    },
    ko = wo,
    _o = St;
    var xo, Eo = function(t, e, i) {
        return e in t ? _o(t, e, {
            value: i,
            enumerable: !0,
            configurable: !0,
            writable: !0
    ...
    q({
        target: "String",
        proto: !0,
        forced: (xo = "trim", s((function() {
            return !! Oo[xo]() || "​᠎" != "​᠎" [xo]() || Oo[xo].name !== xo
        })))
    },
    {
        trim: function() {
    ...
    No = function(t, e) {
        if (k(Bo, t)) return Bo[t];
        e || (e = {});
        var i = [][t],
        o = !!k(e, "ACCESSORS") && e.ACCESSORS,
        n = k(e, 0) ? e[0] : Fo,
        r = k(e, 1) ? e[1] : void 0;
    ...
    qo = function(t) {
        var e = t.forEach;
        return t === Wo || t instanceof Array && e === Wo.forEach || Vo.hasOwnProperty(_e(t)) ? Ho: e
    },
    Uo = Do.trim,
    Yo = r.parseInt,
    Xo = /^[+-]?0[Xx]/,
    Go = 8 !== Yo(Oo + "08") || 22 !== Yo(Oo + "0x16") ?
    function(t, e) {
        var i = Uo(String(t));
        return Yo(i, e >>> 0 || (Xo.test(i) ? 16 : 10))
    }: Yo;
    q({
        global: !0,
        forced: parseInt != Go
    ...
    Zo = function(t) {
        return function(e) {
            for (var i, o = y(e), n = ft(o), r = n.length, s = 0, h = []; r > s;) i = n[s++],
            a && !$o.call(o, i) || h.push(t ? [i, o[i]] : o[i]);
            return h
        }
    },
    Qo = {
    ...
    F.Object.values;
    var Jo, tn, en = It("navigator", "userAgent") || "",
    on = r.process,
    nn = on && on.versions,
    rn = nn && nn.v8;
    rn ? tn = (Jo = rn.split("."))[0] + Jo[1] : en && (!(Jo = en.match(/Edge\/(\d+)/)) || Jo[1] >= 74) && (Jo = en.match(/Chrome\/(\d+)/)) && (tn = Jo[1]);
    var sn = tn && +tn,
    an = pe("species"),
    hn = function(t) {
        return sn >= 51 || !s((function() {
            var e = [];
    ...
    var un = K("Array").filter,
    fn = Array.prototype,
    pn = function(t) {
        var e = t.filter;
        return t === fn || t instanceof Array && e === fn.filter ? un: e
    },
    vn = s((function() {
        Di(1)
    }));
    ...
    var gn = F.Object.getPrototypeOf,
    yn = gn,
    mn = ht.indexOf,
    bn = [].indexOf,
    wn = !!bn && 1 / [1].indexOf(1, -0) < 0,
    kn = Io("indexOf"),
    _n = No("indexOf", {
        ACCESSORS: !0,
        1 : 0
    ...
    {
        indexOf: function(t) {
            return wn ? bn.apply(this, arguments) || 0 : mn(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var xn = K("Array").indexOf,
    En = Array.prototype,
    On = function(t) {
        var e = t.indexOf;
        return t === En || t instanceof Array && e === En.indexOf ? xn: e
    };
    q({
        target: "Array",
        stat: !0
    ...
    Dn = function(t) {
        var e = Object(t);
        return void 0 !== e[Mn] || "@@iterator" in e || Ci.hasOwnProperty(_e(e))
    },
    Pn = pe("isConcatSpreadable"),
    In = 9007199254740991,
    ...
    {
        concat: function(t) {
            var e, i, o, n, r, s = vt(this),
            a = We(s, 0),
            h = 0;
            for (e = -1, o = arguments.length; e < o; e++) if (Nn(r = -1 === e ? s: arguments[e])) {
                if (h + (n = ot(r.length)) > In) throw TypeError(zn);
                for (i = 0; i < n; i++, h++) i in r && Nt(a, h, r[i])
            } else {
                if (h >= In) throw TypeError(zn);
                Nt(a, h++, r)
            }
            return a.length = h,
            a
    ...
    var Rn = An;
    var jn = function(t, e) {
        if (void 0 !== Rn && Dn(Object(t))) {
            var i = [],
            o = !0,
            n = !1,
            r = void 0;
            try {
                for (var s, a = no(t); ! (o = (s = a.next()).done) && (i.push(s.value), !e || i.length !== e); o = !0);
            } catch(t) {
                n = !0,
                r = t
            } finally {
    ...
    },
    {
        slice: function(t, e) {
            ...
            a = st(t, s),
            h = st(void 0 === e ? s: e, s);
            if (Ut(r) && ("function" != typeof(i = r.constructor) || i !== Array && !Ut(i.prototype) ? m(i) && null === (i = i[Vn]) && (i = void 0) : i = void 0, i === Array || void 0 === i)) return qn.call(r, a, h);
            for (o = new(void 0 === i ? Array: i)(Un(h - a, 0)), n = 0; a < h; a++, n++) a in r && Nt(o, n, r[a]);
            return o.length = n,
            o
        }
    });
    var Yn = K("Array").slice,
    Xn = Array.prototype,
    Gn = function(t) {
        var e = t.slice;
        return t === Xn || t instanceof Array && e === Xn.slice ? Yn: e
    },
    Kn = Gn;
    var $n = function(t, e) { (null == e || e > t.length) && (e = t.length);
        for (var i = 0,
    ...
    var Zn = function(t, e) {
        ...
        if (t) {
            ...
            var o = Kn(i = Object.prototype.toString.call(t)).call(i, 8, -1);
            return "Object" === o && t.constructor && (o = t.constructor.name),
            "Map" === o || "Set" === o ? Ln(t) : "Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o) ? $n(t, e) : void 0
        }
    };
    var Qn = function() {
    ...
    hr = function(t) {
        var e = t.map;
        return t === ar || t instanceof Array && e === ar.map ? sr: e
    },
    dr = Cn,
    lr = ve.f("iterator"),
    cr = o((function(t) {
        function e(i) {
            return t.exports = e = "function" == typeof Rn && "symbol" == typeof lr ?
            function(t) {
                return typeof t
            }: function(t) {
                return t && "function" == typeof Rn && t.constructor === Rn && t !== Rn.prototype ? "symbol": typeof t
            },
            e(i)
        }
        t.exports = e
    ...
    var pr = function(t) {
        if (void 0 !== Rn && Dn(Object(t))) return Ln(t)
    };
    var vr = function() {
        throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
    };
    var gr = function(t) {
        return fr(t) || pr(t) || Zn(t) || vr()
    },
    yr = K("Array").concat,
    mr = Array.prototype,
    br = function(t) {
        var e = t.concat;
        return t === mr || t instanceof Array && e === mr.concat ? yr: e
    },
    wr = An;
    function kr(t, e) {
        var i;
        if (void 0 === wr || null == ro(t)) {
            if (dr(t) || (i = function(t, e) {
                var i;
                if (!t) return;
                if ("string" == typeof t) return _r(t, e);
                var o = ur(i = Object.prototype.toString.call(t)).call(i, 8, -1);
                "Object" === o && t.constructor && (o = t.constructor.name);
                if ("Map" === o || "Set" === o) return mo(t);
                if ("Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return _r(t, e)
    ...
    function _r(t, e) { (null == e || e > t.length) && (e = t.length);
        for (var i = 0,
        o = new Array(e); i < e; i++) o[i] = t[i];
        return o
    }
    ...
    var Cr = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i,
    Sr = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
    Tr = /^rgb\( *(1?\d{1,2}|2[0-4]\d|25[0-5]) *, *(1?\d{1,2}|2[0-4]\d|25[0-5]) *, *(1?\d{1,2}|2[0-4]\d|25[0-5]) *\)$/i,
    Mr = /^rgba\( *(1?\d{1,2}|2[0-4]\d|25[0-5]) *, *(1?\d{1,2}|2[0-4]\d|25[0-5]) *, *(1?\d{1,2}|2[0-4]\d|25[0-5]) *, *([01]|0?\.\d+) *\)$/i;
    function Dr(t) {
        if (t) for (; ! 0 === t.hasChildNodes();) {
            var e = t.firstChild;
            e && (Dr(e), t.removeChild(e))
        }
    }
    function Pr(t) {
    ...
    function Ir(t) {
        return "object" === cr(t) && null !== t
    }
    function zr(t, e, i, o) {
        var n = !1; ! 0 === o && (n = null === e[i] && void 0 !== t[i]),
        n ? delete t[i] : t[i] = e[i]
    }
    function Br(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
        for (var o in t) if (void 0 !== e[o]) if (null === e[o] || "object" !== cr(e[o])) zr(t, e, o, i);
        else {
            var n = t[o],
            r = e[o];
            Ir(n) && Ir(r) && Br(n, r, i)
    ...
    function Fr(t, e, i) {
        ...
        if (dr(i)) throw new TypeError("Arrays are not supported by deepExtend");
        for (var n = 0; n < t.length; n++) {
            var r = t[n];
            if (Object.prototype.hasOwnProperty.call(i, r)) if (i[r] && i[r].constructor === Object) void 0 === e[r] && (e[r] = {}),
            e[r].constructor === Object ? Ar(e[r], i[r], !1, o) : zr(e, i, r, o);
            else {
                if (dr(i[r])) throw new TypeError("Arrays are not supported by deepExtend");
                zr(e, i, r, o)
            }
        }
        return e
    ...
    function Nr(t, e, i) {
        ...
        e[n].constructor === Object ? Ar(e[n], i[n]) : zr(e, i, n, o);
        else if (dr(i[n])) {
            e[n] = [];
    ...
    function Ar(t, e) {
        ...
        for (var n in e) if (Object.prototype.hasOwnProperty.call(e, n) || !0 === i) if ("object" === cr(e[n]) && null !== e[n] && yn(e[n]) === Object.prototype) void 0 === t[n] ? t[n] = Ar({},
        e[n], i) : "object" === cr(t[n]) && null !== t[n] && yn(t[n]) === Object.prototype ? Ar(t[n], e[n], i) : zr(t, e, n, o);
        else if (dr(e[n])) {
            var r;
            t[n] = ur(r = e[n]).call(r)
        } else zr(t, e, n, o);
    ...
    function qr(t, e, i) {
        var o;
        return "#" + ur(o = ((1 << 24) + (t << 16) + (e << 8) + i).toString(16)).call(o, 1)
    }
    function Ur(t, e) {
        if (Pr(t)) {
            var i = t;
            if ($r(i)) {
                var o, n = hr(o = i.substr(4).substr(0, i.length - 5).split(",")).call(o, (function(t) {
                    return Ko(t)
                }));
                i = qr(n[0], n[1], n[2])
            }
    ...
    function Qr(t) {
        if (null === t || "object" !== cr(t)) return null;
        if (t instanceof Element) return t;
        var e = ko(t);
        for (var i in t) Object.prototype.hasOwnProperty.call(t, i) && "object" == cr(t[i]) && (e[i] = Qr(t[i]));
        return e
    }
    function Jr(t, e, i) {
        var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
        ...
        if (void 0 !== h) {
            if ("boolean" == typeof h) return r(t[i]) || (t[i] = {}),
            void(t[i].enabled = h);
            if (null === h && !r(t[i])) {
                if (!n(l)) return;
                t[i] = ko(l)
            ...
            if (r(h)) {
                var u = !0;
                void 0 !== h.enabled ? u = h.enabled: void 0 !== c && (u = l.enabled),
                a(t, e, i),
                t[i].enabled = u
            }
        }
    ...
    rs = Math.min,
    ss = 9007199254740991,
    as = "Maximum allowed length exceeded";
    q({
        target: "Array",
        proto: !0,
        forced: !is || !os
    ...
    {
        splice: function(t, e) {
            var i, o, n, r, s, a, h = vt(this),
            d = ot(h.length),
            l = st(t, d),
            c = arguments.length;
            if (0 === c ? i = o = 0 : 1 === c ? (i = 0, o = d - l) : (i = c - 2, o = rs(ns(et(e), 0), d - l)), d + i - o > ss) throw TypeError(as);
            for (n = We(h, o), r = 0; r < o; r++)(s = l + r) in h && Nt(n, r, h[s]);
            if (n.length = o, i < o) {
                for (r = l; r < d - o; r++) a = r + i,
                (s = r + o) in h ? h[a] = h[s] : delete h[a];
                for (r = d; r > d - o + i; r--) delete h[r - 1]
            } else if (i > o) for (r = d - o; r > l; r--) a = r + i - 1,
            (s = r + o - 1) in h ? h[a] = h[s] : delete h[a];
            for (r = 0; r < i; r++) h[r + l] = arguments[r + 2];
            return h.length = d - o + i,
            n
        }
    });
    var hs = K("Array").splice,
    ds = Array.prototype,
    ls = function(t) {
        var e = t.splice;
        return t === ds || t instanceof Array && e === ds.splice ? hs: e
    },
    cs = ht.includes,
    us = No("indexOf", {
        ACCESSORS: !0,
    ...
    var fs = K("Array").includes,
    ps = pe("match"),
    vs = function(t) {
        if (function(t) {
            var e;
            return m(t) && (void 0 !== (e = t[ps]) ? !!e: "RegExp" == f(t))
    ...
    {
        includes: function(t) {
            return !! ~String(g(this)).indexOf(vs(t), arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var ys = K("String").includes,
    ms = Array.prototype,
    bs = String.prototype,
    ws = function(t) {
        var e = t.includes;
        return t === ms || t instanceof Array && e === ms.includes ? fs: "string" == typeof t || t === bs || t instanceof String && e === bs.includes ? ys: e
    };
    function ks(t) {
        return Ms = t,
        function() {
            ...
            void(Ps = Ms.charAt(0)),
            Vs(),
            "strict" === Is && (t.strict = !0, Vs());
            "graph" !== Is && "digraph" !== Is || (t.type = Is, Vs());
            zs === Cs && (t.id = Is, Vs());
            if ("{" != Is) throw Ks("Angle bracket { expected");
            if (Vs(), qs(t), "}" != Is) throw Ks("Angle bracket } expected");
            if (Vs(), "" !== Is) throw Ks("End of file expected");
            return Vs(),
            delete t.node,
            delete t.edge,
            delete t.graph,
    ...
    function Ls(t, e) {
        for (var i, o, n = null,
        r = [t], s = t; s.parent;) r.push(s.parent),
        s = s.parent;
        ...
        t.node && (n.attr = Rs(n.attr, t.node))), i = r.length - 1; i >= 0; i--) {
            var a, h = r[i];
            h.nodes || (h.nodes = []),
            -1 === On(a = h.nodes).call(a, n) && h.nodes.push(n)
        }
        e.attr && (n.attr = Rs(n.attr, e.attr))
    }
    function Hs(t, e) {
    ...
    function Ws(t, e, i, o, n) {
        var r = {
            from: e,
            to: i,
            type: o
        };
        return t.edge && (r.attr = Rs({},
        t.edge)),
        r.attr = Rs(r.attr || {},
        n),
        null != n && n.hasOwnProperty("arrows") && null != n.arrows && (r.arrows = {
            to: {
                enabled: !0,
                type: n.arrows.type
            }
    ...
    function Vs() {
        ...
        do {
            ...
            if ("#" === Ps) {
                for (var e = Ds - 1;
                " " === Ms.charAt(e) || "\t" === Ms.charAt(e);) e--;
                if ("\n" === Ms.charAt(e) || "" === Ms.charAt(e)) {
                    for (;
                    "" != Ps && "\n" != Ps;) Bs();
                    t = !0
                }
        ...
        if ("" !== Ps) {
            var i = Ps + Fs();
            if (Ts[i]) return zs = Os,
            Is = i,
            Bs(),
            void Bs();
            if (Ts[Ps]) return zs = Os,
            Is = Ps,
            void Bs();
            if (As(Ps) || "-" === Ps) {
                for (Is += Ps, Bs(); As(Ps);) Is += Ps,
                Bs();
                return "false" === Is ? Is = !1 : "true" === Is ? Is = !0 : isNaN(Number(Is)) || (Is = Number(Is)),
                void(zs = Cs)
            }
            if ('"' === Ps) {
                for (Bs();
                "" != Ps && ('"' != Ps || '"' === Ps && '"' === Fs());)'"' === Ps ? (Is += Ps, Bs()) : "\\" === Ps && "n" === Fs() ? (Is += "\n", Bs()) : Is += Ps,
                Bs();
                if ('"' != Ps) throw Ks('End of string " expected');
                return Bs(),
                void(zs = Cs)
            }
            for (zs = Ss;
            "" != Ps;) Is += Ps,
            Bs();
            throw new SyntaxError('Syntax error in part "' + $s(Is, 30) + '"')
        }
        zs = Os
    }
    function qs(t) {
    ...
    function Us(t) {
        ...
        function(t) {
            if ("node" === Is) return Vs(),
            t.node = Gs(),
            "node";
            if ("edge" === Is) return Vs(),
            t.edge = Gs(),
            "edge";
            if ("graph" === Is) return Vs(),
            t.graph = Gs(),
            "graph";
            return null
        } (t)) {
            if (zs != Cs) throw Ks("Identifier expected");
            var i = Is;
            if (Vs(), "=" === Is) {
                if (Vs(), zs != Cs) throw Ks("Identifier expected");
                t[i] = Is,
                Vs()
            } else !
            function(t, e) {
    ...
    function Ys(t) {
        var e = null;
        if ("subgraph" === Is && ((e = {}).type = "subgraph", Vs(), zs === Cs && (e.id = Is, Vs())), "{" === Is) {
            if (Vs(), e || (e = {}), e.parent = t, e.node = t.node, e.edge = t.edge, e.graph = t.graph, qs(e), "}" != Is) throw Ks("Angle bracket } expected");
            Vs(),
            delete e.node,
            delete e.edge,
            delete e.graph,
    ...
    function Xs(t, e) {
        ...
        "->" === Is || "--" === Is;) {
            ...
            if (n) i = n;
                ...
                if (zs != Cs) throw Ks("Identifier or subgraph expected");
                Ls(t, {
                    id: i = Is
                }),
                Vs()
    ...
    function Gs() {
        ...
        "[" === Is;) {
            for (Vs(), i = {};
            "" !== Is && "]" != Is;) {
                if (zs != Cs) throw Ks("Attribute name expected");
                var a = Is;
                if (Vs(), "=" != Is) throw Ks("Equal sign = expected");
                if (Vs(), zs != Cs) throw Ks("Attribute value expected");
                var h = Is;
                "style" === a && (h = o[h]),
                "arrowhead" === a && (a = "arrows", h = {
                    to: {
                        enabled: !0,
                        type: n[h]
                    }
            ...
            if ("]" != Is) throw Ks("Bracket ] expected");
            Vs()
        }
        if (ws(s).call(s, "dir")) {
            var d = {
            ...
            for (t = 0; t < r.length; t++) if ("arrows" === r[t].name) if (null != r[t].value.to) d.arrows.to = t;
            else {
                if (null == r[t].value.from) throw Ks("Invalid value of arrows");
                d.arrows.from = t
            } else "dir" === r[t].name && (d.dir = t);
            var l, c, u = r[d.dir].value;
            if (!ws(s).call(s, "arrows")) if ("both" === u) r.push({
                attr: r[d.dir].attr,
                name: "arrows",
                value: {
                    to: {
            ...
            d.arrows.from = r.length - 1;
                ...
                if ("none" !== u) throw Ks('Invalid dir type "' + u + '"');
                r.push({
                    attr: r[d.dir].attr,
                    name: "arrows",
                    value: ""
            ...
            ls(r).call(r, d.arrows.from, 1)) : d.arrows.to ? (c = r[d.arrows.to].value.to.type, l = "arrow", r[d.arrows.to] = {
                attr: r[d.arrows.to].attr,
                name: r[d.arrows.to].name,
                value: {
                    to: {
            ...
            r[d.arrows.from] = {
                ...
                if ("forward" !== u) throw Ks('Invalid dir type "' + u + '"');
    ...
    function Ks(t) {
        return new SyntaxError(t + ', got "' + $s(Is, 30) + '" (char ' + Ds + ")")
    }
    function $s(t, e) {
    ...
    function Qs(t, e) {
        ...
        for (var o in t) if (t.hasOwnProperty(o)) {
            var n = e[o];
            dr(n) ? qo(n).call(n, (function(e) {
                Zs(i, e, t[o])
            })) : Zs(i, "string" == typeof n ? n: o, t[o])
        }
        return i
    }
    function Js(t) {
        ...
        i.nodes && qo(e = i.nodes).call(e, (function(t) {
            var e = {
                id: t.id,
        ...
        if (i.edges) {
            var n, r = function(t) {
                ...
                return Rs(e, Qs(t.attr, xs)),
                null == e.arrows && "->" === t.type && (e.arrows = "to"),
                e
            };
            qo(n = i.edges).call(n, (function(t) {
                var e, i, n, s, a, h, d; (e = t.from instanceof Object ? t.from.nodes: {
                    id: t.from
                },
                i = t.to instanceof Object ? t.to.nodes: {
                    id: t.to
                },
                t.from instanceof Object && t.from.edges) && qo(n = t.from.edges).call(n, (function(t) {
                    var e = r(t);
                    o.edges.push(e)
                })); (a = i, h = function(e, i) {
                    var n = Ws(o, e.id, i.id, t.type, t.attr),
                    s = r(n);
                    o.edges.push(s)
                },
                dr(s = e) ? qo(s).call(s, (function(t) {
                    dr(a) ? qo(a).call(a, (function(e) {
                        h(t, e)
                    })) : h(t, a)
                })) : dr(a) ? qo(a).call(a, (function(t) {
                    h(s, t)
                })) : h(s, a), t.to instanceof Object && t.to.edges) && qo(d = t.to.edges).call(d, (function(t) {
                    var e = r(t);
                    o.edges.push(e)
                }))
            }))
        }
        return i.attr && (o.options = i.attr),
        o
    }
    ...
    function ea(t, e) {
        ...
        return {
            nodes: hr(i = t.nodes).call(i, (function(t) {
                var e = {
                    id: t.id,
                ...
                null != t.x && (e.x = t.x),
                null != t.y && (e.y = t.y),
                null != t.color && (!0 === o.nodes.parseColor ? e.color = t.color: e.color = {
                    background: t.color,
                    border: t.color,
                    highlight: {
                        background: t.color,
    ...
    q({
        target: "Array",
        proto: !0,
        forced: String(na) === String(na.reverse())
    },
    {
        reverse: function() {
            return Ut(this) && (this.length = this.length),
            oa.call(this)
        }
    });
    var ra = K("Array").reverse,
    sa = Array.prototype,
    aa = function(t) {
        var e = t.reverse;
        return t === sa || t instanceof Array && e === sa.reverse ? ra: e
    };
    ...
    var ca, ua = "function" != typeof Object.assign ?
    function(t) {
    ...
    fa = ["", "webkit", "Moz", "MS", "ms", "o"],
    pa = "undefined" == typeof document ? {
        style: {}
    ...
    ya = Date.now;
    function ma(t, e) {
        for (var i, o, n = e[0].toUpperCase() + e.slice(1), r = 0; r < fa.length;) {
            if ((o = (i = fa[r]) ? i + n: e) in t) return o;
            r++
        }
    }
    ca = "undefined" == typeof window ? {}: window;
    var ba = ma(pa.style, "touchAction"),
    wa = void 0 !== ba;
    var ka = "compute",
    _a = "auto",
    xa = "manipulation",
    ...
    Sa = function() {
        if (!wa) return ! 1;
        var t = {},
        e = ca.CSS && ca.CSS.supports;
        return ["auto", "manipulation", "pan-y", "pan-x", "pan-x pan-y", "none"].forEach((function(i) {
            return t[i] = !e || ca.CSS.supports("touch-action", i)
        })),
        t
    } (),
    Ta = "ontouchstart" in ca,
    Ma = void 0 !== ma(ca, "PointerEvent"),
    Da = Ta && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),
    Pa = "touch",
    Ia = "mouse",
    za = 16,
    Ba = 24,
    ...
    function Aa(t, e, i) {
        ...
        else if (void 0 !== t.length) for (o = 0; o < t.length;) e.call(i, t[o], o, t),
        o++;
    ...
    var La = function() {
        ...
        return e.set = function(t) {
            t === ka && (t = this.compute()),
            wa && this.manager.element.style && Sa[t] && (this.manager.element.style[ba] = t),
        ...
        e.compute = function() {
            var t = [];
            return Aa(this.manager.recognizers, (function(e) {
                Ra(e.options.enable, [e]) && (t = t.concat(e.getTouchAction()))
            })),
            function(t) {
                if (ja(t, Ea)) return Ea;
                var e = ja(t, Oa),
                i = ja(t, Ca);
                return e && i ? Ea: e || i ? e ? Oa: Ca: ja(t, xa) ? xa: _a
            } (t.join(" "))
        },
        e.preventDefaults = function(t) {
            ...
            if (this.manager.session.prevented) e.preventDefault();
                ...
                if (!s || !r) return n || r && 6 & i || s && i & Ba ? this.preventSrc(e) : void 0
            }
        },
    ...
    function Va(t) {
        for (var e = [], i = 0; i < t.pointers.length;) e[i] = {
            clientX: va(t.pointers[i].clientX),
            clientY: va(t.pointers[i].clientY)
        },
        i++;
        return {
            timeStamp: ya(),
    ...
    function Ya(t, e) {
        return t === e ? 1 : ga(t) >= ga(e) ? t < 0 ? 2 : 4 : e < 0 ? 8 : za
    }
    function Xa(t, e, i) {
        return {
            x: e / t || 0,
    ...
    function Ga(t, e) {
        ...
        o = e.pointers,
        n = o.length;
        i.firstInput || (i.firstInput = Va(e)),
        n > 1 && !i.firstMultiple ? i.firstMultiple = Va(e) : 1 === n && (i.firstMultiple = !1);
        var r = i.firstInput,
        s = i.firstMultiple,
        ...
        e.offsetDirection = Ya(e.deltaX, e.deltaY);
        var d, l, c = Xa(e.deltaTime, e.deltaX, e.deltaY);
        e.overallVelocityX = c.x,
        e.overallVelocityY = c.y,
        e.overallVelocity = ga(c.x) > ga(c.y) ? c.x: c.y,
        e.scale = s ? (d = s.pointers, qa((l = o)[0], l[1], Na) / qa(d[0], d[1], Na)) : 1,
        e.rotation = s ?
        function(t, e) {
            return Ua(e[1], e[0], Na) + Ua(t[1], t[0], Na)
        } (s.pointers, o) : 0,
        ...
        function(t, e) {
            var i, o, n, r, s = t.lastInterval || e,
        ...
        var u, f = t.element,
        p = e.srcEvent;
        Ha(u = p.composedPath ? p.composedPath()[0] : p.path ? p.path[0] : p.target, f) && (f = u),
        e.target = f
    }
    function Ka(t, e, i) {
    ...
    var th = function() {
        function t(t, e) {
            ...
            this.domHandler = function(e) {
                Ra(t.options.enable, [t]) && i.handler(e)
            },
            this.init()
        }
        var e = t.prototype;
        ...
        e.init = function() {
            this.evEl && Za(this.element, this.evEl, this.domHandler),
            this.evTarget && Za(this.target, this.evTarget, this.domHandler),
            this.evWin && Za(Ja(this.element), this.evWin, this.domHandler)
        },
        e.destroy = function() {
            this.evEl && Qa(this.element, this.evEl, this.domHandler),
            this.evTarget && Qa(this.target, this.evTarget, this.domHandler),
            this.evWin && Qa(Ja(this.element), this.evWin, this.domHandler)
        },
        t
    } ();
    function eh(t, e, i) {
    ...
    nh = "pointerdown",
    rh = "pointermove pointerup pointercancel";
    ca.MSPointerEvent && !ca.PointerEvent && (nh = "MSPointerDown", rh = "MSPointerMove MSPointerUp MSPointerCancel");
    var sh = function(t) {
        function e() {
            var i, o = e.prototype;
            return o.evEl = nh,
        ...
        e.prototype.handler = function(t) {
            ...
            n = ih[o],
            r = oh[t.pointerType] || t.pointerType,
            s = r === Pa,
            a = eh(e, t.pointerId, "pointerId");
            1 & n && (0 === t.button || s) ? a < 0 && (e.push(t), a = e.length - 1) : 12 & n && (i = !0),
            a < 0 || (e[a] = t, this.callback(this.manager, n, {
                pointers: e,
                changedPointers: [t],
                pointerType: r,
                srcEvent: t
    ...
    lh = "touchstart touchmove touchend touchcancel",
    ch = function(t) {
        function e() {
            var i;
            return e.prototype.evTarget = lh,
    ...
    function uh(t, e) {
        var i, o, n = ah(t.touches),
        r = this.targetIds;
        if (3 & e && 1 === n.length) return r[n[0].identifier] = !0,
        [n, n];
        var s = ah(t.changedTouches),
        a = [],
        h = this.target;
        if (o = n.filter((function(t) {
            return Ha(t.target, h)
        })), 1 === e) for (i = 0; i < o.length;) r[o[i].identifier] = !0,
        i++;
        for (i = 0; i < s.length;) r[s[i].identifier] && a.push(s[i]),
        12 & e && delete r[s[i].identifier],
        i++;
        return a.length ? [hh(o.concat(a), "identifier", !0), a] : void 0
    }
    var fh = {
        mousedown: 1,
        mousemove: 2,
    ...
    gh = function(t) {
        ...
        e.prototype.handler = function(t) {
            ...
            2 & e && 1 !== t.which && (e = 4),
            this.pressed && (4 & e && (this.pressed = !1), this.callback(this.manager, e, {
                pointers: [t],
                changedPointers: [t],
                pointerType: Ia,
                srcEvent: t
    ...
    function mh(t, e) {
        1 & t ? (this.primaryTouch = e.changedPointers[0].identifier, yh.call(this, e)) : 12 & t && yh.call(this, e)
    }
    function bh(t) {
        for (var e = t.srcEvent.clientX,
        i = t.srcEvent.clientY,
        o = 0; o < this.lastTouches.length; o++) {
        ...
        return function(t) {
            function e(e, i) {
                ...
                return (o = t.call(this, e, i) || this).handler = function(t, e, i) {
                    var n = i.pointerType === Pa,
                    r = i.pointerType === Ia;
                    if (! (r && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
                        if (n) mh.call(la(la(o)), e, i);
                        else if (r && bh.call(la(la(o)), i)) return;
                        o.callback(t, e, i)
                    }
                },
                o.touch = new ch(o.manager, o.handler),
                o.mouse = new gh(o.manager, o.handler),
                o.primaryTouch = null,
                o.lastTouches = [],
                o
            }
    ...
    function kh(t, e, i) {
        return !! Array.isArray(t) && (Aa(t, i[e], i), !0)
    }
    var _h = 32,
    xh = 1;
    function Eh(t, e) {
    ...
    var Ch = function() {
        ...
        var e = t.prototype;
        return e.set = function(t) {
            return ua(this.options, t),
            this.manager && this.manager.touchAction.update(),
            this
        },
        e.recognizeWith = function(t) {
            if (kh(t, "recognizeWith", this)) return this;
            var e = this.simultaneous;
            return e[(t = Eh(t, this)).id] || (e[t.id] = t, t.recognizeWith(this)),
            this
        },
        e.dropRecognizeWith = function(t) {
            return kh(t, "dropRecognizeWith", this) || (t = Eh(t, this), delete this.simultaneous[t.id]),
            this
        },
        e.requireFailure = function(t) {
            if (kh(t, "requireFailure", this)) return this;
            var e = this.requireFail;
            return - 1 === eh(e, t = Eh(t, this)) && (e.push(t), t.requireFailure(this)),
            this
        },
        e.dropRequireFailure = function(t) {
            if (kh(t, "dropRequireFailure", this)) return this;
            t = Eh(t, this);
            var e = eh(this.requireFail, t);
        ...
        e.recognize = function(t) {
            var e = ua({},
            t);
            if (!Ra(this.options.enable, [this, e])) return this.reset(),
            void(this.state = _h);
    ...
    Sh = function(t) {
        ...
        i.process = function(t) {
            ...
            if (n && r && o) {
                ...
                a = !this.pCenter || qa(this.pCenter, t.center) < i.posThreshold;
    ...
    Th = function(t) {
        ...
        i.process = function(t) {
            ...
            o = 6 & e,
            n = this.attrTest(t);
            return o && (8 & i || !n) ? 16 | e: o || n ? 4 & i ? 8 | e: 2 & e ? 4 | e: 2 : _h
        },
        e
    } (Ch);
    function Mh(t) {
        return t === za ? "down": 8 === t ? "up": 2 === t ? "left": 4 === t ? "right": ""
    }
    var Dh = function(t) {
        function e(e) {
            var i;
        ...
        i.directionTest = function(t) {
            ...
            r = t.deltaX,
            s = t.deltaY;
            return n & e.direction || (6 & e.direction ? (n = 0 === r ? 1 : r < 0 ? 2 : 4, i = r !== this.pX, o = Math.abs(t.deltaX)) : (n = 0 === s ? 1 : s < 0 ? 8 : za, i = s !== this.pY, o = Math.abs(t.deltaY))),
            t.direction = n,
            i && o > e.threshold && n & e.direction
        },
        i.attrTest = function(t) {
            return Th.prototype.attrTest.call(this, t) && (2 & this.state || !(2 & this.state) && this.directionTest(t))
        },
        i.emit = function(e) {
            this.pX = e.deltaX,
            this.pY = e.deltaY;
            var i = Mh(e.direction);
    ...
    Ph = function(t) {
        ...
        var i = e.prototype;
        return i.getTouchAction = function() {
            return Dh.prototype.getTouchAction.call(this)
        },
        i.attrTest = function(e) {
            var i, o = this.options.direction;
            return 30 & o ? i = e.overallVelocity: 6 & o ? i = e.overallVelocityX: o & Ba && (i = e.overallVelocityY),
            t.prototype.attrTest.call(this, e) && o & e.offsetDirection && e.distance > this.options.threshold && e.maxPointers === this.options.pointers && ga(i) > this.options.velocity && 4 & e.eventType
        },
        i.emit = function(t) {
            var e = Mh(t.offsetDirection);
    ...
    Bh = function(t) {
        ...
        i.process = function(t) {
            ...
            else if (1 & t.eventType) this.reset(),
        ...
        i.emit = function(t) {
            8 === this.state && (t && 4 & t.eventType ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = ya(), this.manager.emit(this.options.event, this._input)))
        },
        e
    } (Ch),
    Fh = {
    ...
    function Ah(t, e) {
        var i, o = t.element;
        o.style && (Aa(t.options.cssProps, (function(n, r) {
            i = ma(o.style, r),
            e ? (t.oldCssProps[i] = o.style[i], o.style[i] = n) : o.style[i] = t.oldCssProps[i] || ""
        })), e || (t.oldCssProps = {}))
    }
    var Rh = function() {
        function t(t, e) {
            ...
            this.oldCssProps = {},
            this.element = t,
            this.input = new((i = this).options.inputClass || (Ma ? sh: Da ? ch: Ta ? wh: gh))(i, Ka),
            this.touchAction = new La(this, this.options.touchAction),
            Ah(this, !0),
            Aa(this.options.recognizers, (function(t) {
        ...
        e.remove = function(t) {
            if (kh(t, "remove", this)) return this;
            var e = this.get(t);
            if (t) {
                var i = this.recognizers,
                o = eh(i, e); - 1 !== o && (i.splice(o, 1), this.touchAction.update())
            }
            return this
        },
        e.on = function(t, e) {
        ...
        e.off = function(t, e) {
            ...
            var i = this.handlers;
            return Aa($a(t), (function(t) {
                e ? i[t] && i[t].splice(eh(i[t], e), 1) : delete i[t]
            })),
            this
        },
        e.emit = function(t, e) {
            ...
            if (i && i.length) {
                ...
                for (var o = 0; o < i.length;) i[o](e),
                o++
            }
        },
        e.destroy = function() {
            this.element && Ah(this, !1),
            this.handlers = {},
            this.session = {},
            this.input.destroy(),
            this.element = null
    ...
    Lh = "touchstart",
    Hh = "touchstart touchmove touchend touchcancel",
    Wh = function(t) {
        function e() {
            var i, o = e.prototype;
            return o.evTarget = Lh,
            o.evWin = Hh,
    ...
    function Vh(t, e) {
        var i = ah(t.touches),
        o = ah(t.changedTouches);
        return 12 & e && (i = hh(i.concat(o), "identifier", !0)),
        [i, o]
    }
    function qh(t, e, i) {
    ...
    function Xh(t, e, i) {
        var o, n = e.prototype; (o = t.prototype = Object.create(n)).constructor = t,
        o._super = n,
        i && ua(o, i)
    }
    function Gh(t, e) {
    ...
    var Kh = function() {
        ...
        t.TouchInput = ch,
        t.MouseInput = gh,
        t.PointerEventInput = sh,
        t.TouchMouseInput = wh,
        t.SingleTouchInput = Wh,
        t.Recognizer = Ch,
        t.AttrRecognizer = Th,
        t.Tap = Sh,
        t.Pan = Dh,
        ...
        t.boolOrFn = Ra,
        t.hasParent = Ha,
        t.addEventListeners = Za,
        t.removeEventListeners = Qa,
        t.defaults = ua({},
        Fh, {
            preset: Nh
        }),
    ...
    var $h = "undefined" != typeof window ? window.Hammer || Kh: function() {
        return {
            on: t = function() {},
            off: t,
            destroy: t,
    ...
    function Zh(t, e) {
        ...
        if (void 0 === wr || null == ro(t)) {
            if (dr(t) || (i = function(t, e) {
                var i;
                if (!t) return;
                if ("string" == typeof t) return Qh(t, e);
                var o = ur(i = Object.prototype.toString.call(t)).call(i, 8, -1);
                "Object" === o && t.constructor && (o = t.constructor.name);
                if ("Map" === o || "Set" === o) return mo(t);
                if ("Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return Qh(t, e)
            } (t)) || e && t && "number" == typeof t.length) {
                i && (t = i);
                var o = 0,
                n = function() {};
    ...
    function Qh(t, e) { (null == e || e > t.length) && (e = t.length);
        for (var i = 0,
        o = new Array(e); i < e; i++) o[i] = t[i];
        return o
    }
    function Jh(t) {
        ...
        var o = $h(this._dom.overlay);
        o.on("tap", Q(e = this._onTapOverlay).call(e, this)),
        this._cleanupQueue.push((function() {
            o.destroy()
        }));
        var n = ["tap", "doubletap", "press", "pinch", "pan", "panstart", "panmove", "panend"];
        qo(n).call(n, (function(t) {
            o.on(t, (function(t) {
                t.srcEvent.stopPropagation()
            }))
        })),
        document && document.body && (this._onClick = function(e) { (function(t, e) {
                for (; t;) {
                    if (t === e) return ! 0;
                    t = t.parentNode
                }
        ...
        this._escListener = function(t) { ("key" in t ? "Escape" === t.key: 27 === t.keyCode) && i.deactivate()
        }
    }
    Ct(Jh.prototype),
    Jh.current = null,
    Jh.prototype.destroy = function() {
        var t, e;
        this.deactivate();
        var i, o = Zh(aa(t = ls(e = this._cleanupQueue).call(e, 0)).call(t));
        try {
    ...
    Jh.prototype.activate = function() {
        Jh.current && Jh.current.deactivate(),
        Jh.current = this,
        this.active = !0,
    ...
    Jh.prototype._onTapOverlay = function(t) {
        this.activate(),
        t.srcEvent.stopPropagation()
    };
        ...
        return od(t, [{
            ...
            value: function() {
                if (!this.initialized()) {
                    ...
                    this.coordinates = [[0, 0, s, i], [s, 0, a, o], [s, o, h, n], [5 * h, o, d, r]],
                    this._fillMipMap()
                }
            }
        },
    ...
    ad = o((function(t) {
        ...
        s = t.exports = {
            ...
            onFreeze: function(t) {
                return sd && s.REQUIRED && n(t) && !k(t, i) && r(t),
                t
            }
        };
        dt[i] = !0
    ...
    dd = function(t, e, i) {
        ...
        g = function(t) {
            return c ? (R(t), f ? p(t[0], t[1], v) : p(t[0], t[1])) : f ? p(t, v) : p(t)
        };
        if (u) o = t;
        else {
            if ("function" != typeof(n = oo(t))) throw TypeError("Target is not iterable");
            if (co(n)) {
                for (r = 0, s = ot(t.length); s > r; r++) if ((a = g(t[r])) && a instanceof hd) return a;
                return new hd(!1)
            }
            o = n.call(t)
        }
        for (h = o.next; ! (d = h.call(o)).done;) {
            ...
            if ("object" == typeof a && a && a instanceof hd) return a
        }
        return new hd(!1)
    },
    ld = function(t, e, i) {
    ...
    pd = Le.getterFor,
    vd = function(t, e, i) {
        var o, n = -1 !== t.indexOf("Map"),
        h = -1 !== t.indexOf("Weak"),
        d = n ? "set": "add",
        l = r[t],
        c = l && l.prototype,
        u = {};
        if (a && "function" == typeof l && (h || c.forEach && !s((function() { (new l).entries().next()
        })))) {
            o = e((function(e, i) {
                fd(ld(e, o, t), {
                    type: t,
            ...
            var f = pd(t);
            ud(["add", "clear", "delete", "forEach", "get", "has", "set", "keys", "values", "entries"], (function(t) {
                var e = "add" == t || "set" == t; ! (t in c) || h && "clear" == t || H(o.prototype, t, (function(i, o) {
            ...
            h || cd(o.prototype, "size", {
                configurable: !0,
                get: function() {
                    return f(this).collection.size
                }
            })
        } else o = i.getConstructor(e, t, n, d),
        ad.REQUIRED = !0;
        return Ce(o, t, !1, !0),
        u[t] = o,
        q({
        ...
        },
        {
            ...
            value: function(t) {
                ...
                if (void 0 === i && e) if (!1 === this.options.useDefaultGroups && this._groupNames.length > 0) {
                    var o = this._groupIndex % this._groupNames.length; ++this._groupIndex,
                    (i = {}).color = this._groups.get(this._groupNames[o]),
                    this._groups.set(t, i)
                } else {
                    var n = this._defaultIndex % this._defaultGroups.length;
                    this._defaultIndex++,
                    (i = {}).color = this._defaultGroups[n],
                    this._groups.set(t, i)
                }
                return i
            }
    ...
    Sd = function(t) {
        return function(e, i) {
            ...
            n = o ? Od.call(arguments, 2) : void 0;
            return t(o ?
    ...
    Bd = function(t) {
        var e = t.some;
        return t === zd || t instanceof Array && e === zd.some ? Id: e
    },
    Fd = r.isFinite,
    Nd = Number.isFinite ||
    function(t) {
        return "number" == typeof t && Fd(t)
    };
    q({
        target: "Number",
        stat: !0
    ...
    {
        getOwnPropertyNames: jd
    });
    var Hd = F.Object,
    Wd = function(t) {
        return Hd.getOwnPropertyNames(t)
    },
    Vd = Do.trim,
    qd = r.parseFloat,
    Ud = 1 / qd(Oo + "-0") != -1 / 0 ?
    ...
    tl = function(t) {
        var e = t.values;
        return t === Qd || t instanceof Array && e === Qd.values || Jd.hasOwnProperty(_e(t)) ? Zd: e
    },
    el = function() {
        function t(e) {
            ed(this, t),
            ...
            value: function() {
                for (var t = [], e = 0; e < this.lines.length; e++) {
                    ...
                    if (0 !== i.blocks.length && (e !== this.lines.length - 1 || 0 !== i.width)) {
                        ...
                        o.blocks = [];
                        for (var n = void 0,
                        r = [], s = 0; s < i.blocks.length; s++) {
                            var a = i.blocks[s];
                            0 !== a.width ? r.push(a) : void 0 === n && (n = a)
                        }
                        0 === r.length && void 0 !== n && r.push(n),
                        o.blocks = r,
                        t.push(o)
                    }
                }
    ...
    ol = function() {
        ...
        },
        {
            ...
            value: function(t) {
                var e, i;
                if (t instanceof RegExp) i = t,
                e = 1;
                else {
                    var o = il[t];
                    i = void 0 !== o ? o: new RegExp(t),
                    e = t.length
                }
                return [i, e]
            }
    ...
    nl = function() {
        function t(e, i, o, n) {
            ...
            this.selected = o,
            this.hover = n;
            this.lines = new el((function(t, i) {
        ...
        return od(t, [{
            key: "process",
            value: function(t) {
                if (!Kd(t)) return this.lines.finalize();
        ...
        },
        {
            key: "splitHtmlBlocks",
            value: function(t) {
                for (var e = new ol(t), i = function(t) {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                i = new ol(t), o = !0, n = function(t) {
                    ...
                    i.parseWS(r) || n(r) || (o || i.spacing) && (i.parseStartTag("bold", "*") || i.parseStartTag("ital", "_") || i.parseStartTag("mono", "`")) || i.parseEndTag("bold", "*", "afterBold") || i.parseEndTag("ital", "_", "afterItal") || i.parseEndTag("mono", "`", "afterMono") || (i.add(r), o = !1),
                    i.position++
                }
                return i.emitBlock(),
                i.blocks
        ...
        },
        {
            ...
            value: function(t) {
                for (var e = 0; e < t.length && !this.overMaxWidth(ur(t).call(t, 0, e));) e++;
                return e
            }
        },
        {
            ...
            value: function(t) {
                ...
                for (var o = (t = (t = t.replace(/^( +)/g, "$1\r")).replace(/([^\r][^ ]*)( +)/g, "$1\r$2\r")).split("\r"); o.length > 0;) {
                    ...
                    if (0 === n) {
                        ...
                        this.lines.newLine(ur(r).call(r, 0, s), e),
                        o[0] = ur(r).call(r, s)
                    } else {
                        var a = n;
                        " " === o[n - 1] ? n--:" " === o[a] && a++;
                        var h = ur(o).call(o, 0, n).join("");
    ...
    sl = function() {
        ...
        return od(t, [{
            key: "setOptions",
            value: function(t) {
                if (this.elementOptions = t, this.initFontOptions(t.font), Kd(t.label) ? this.labelDirty = !0 : t.label = void 0, void 0 !== t.font && null !== t.font) if ("string" == typeof t.font) this.baseSize = this.fontOptions.size;
                else if ("object" === cr(t.font)) {
                    var e = t.font.size;
        ...
        },
        {
            ...
            value: function(e) {
                ...
                t.parseFontString(this.fontOptions, e) ? this.fontOptions.vadjust = 0 : Hr(e, (function(t, e) {
                    null != t && "object" !== cr(t) && (i.fontOptions[e] = t)
                }))
            }
        },
        {
            ...
            value: function(t) {
                ...
                i = es(t, "widthConstraint");
                if ("number" == typeof i) e.maxWdt = Number(i),
                e.minWdt = Number(i);
                else if ("object" === cr(i)) {
                    var o = es(t, ["widthConstraint", "maximum"]);
                    "number" == typeof o && (e.maxWdt = Number(o));
                    var n = es(t, ["widthConstraint", "minimum"]);
                    "number" == typeof n && (e.minWdt = Number(n))
                }
                var r = es(t, "heightConstraint");
                if ("number" == typeof r) e.minHgt = Number(r);
                else if ("object" === cr(r)) {
                    var s = es(t, ["heightConstraint", "minimum"]);
                    "number" == typeof s && (e.minHgt = Number(s));
                    var a = es(t, ["heightConstraint", "valign"]);
        ...
        },
        {
            ...
            value: function(t, e) {
                ...
                Ar(this.fontOptions, this.constrain(e)),
                this.fontOptions.chooser = Xd("label", e)
            }
        },
        {
            key: "adjustSizes",
        ...
        },
        {
            ...
            value: function(e) {
                ...
                o = 0; o < e.length; ++o) {
                    var n = e[o],
                    r = {};
                    t.parseFontString(r, n) && (n = r),
                    Hr(n, (function(t, e) {
                        void 0 !== t && (Object.prototype.hasOwnProperty.call(i, e) || ( - 1 !== On(rl).call(rl, e) ? i[e] = {}: i[e] = t))
                    }))
                }
                return i
            }
        ...
        },
        {
            ...
            value: function(t, e) {
                for (var i = {},
                o = ["color", "size", "face", "mod", "vadjust"], n = 0; n < o.length; ++n) {
                    var r = o[n];
        ...
        },
        {
            ...
            value: function(t) {
                ...
                for (var o = function(t) {
                    var o = rl[t],
                    n = e.fontOptions[o];
                    Hr(e.getFontOptions(i, o), (function(t, e) {
                        n[e] = t
                    })),
                    n.size = Number(n.size),
                    n.vadjust = Number(n.vadjust)
                },
                n = 0; n < rl.length; ++n) o(n)
            }
        },
        {
            key: "draw",
        ...
        },
        {
            ...
            value: function(t, e, i) {
                ...
                t.textAlign = "left",
                e -= this.size.width / 2,
                this.fontOptions.valign && this.size.height > this.size.labelHeight && ("top" === this.fontOptions.valign && (i -= (this.size.height - this.size.labelHeight) / 2), "bottom" === this.fontOptions.valign && (i += (this.size.height - this.size.labelHeight) / 2));
                for (var a = 0; a < this.lineCount; a++) {
                    ...
                    if (h && h.blocks) {
                        ...
                        for (var l = 0; l < h.blocks.length; l++) {
                            ...
                            p = f[0],
                            v = f[1];
                            c.strokeWidth > 0 && (t.lineWidth = c.strokeWidth, t.strokeStyle = v, t.lineJoin = "round"),
                            t.fillStyle = p,
                            c.strokeWidth > 0 && t.strokeText(c.text, e + d, i + c.vadjust),
                            t.fillText(c.text, e + d, i + c.vadjust),
                            d += c.width
                        }
                        i += h.height
                    }
        ...
        },
        {
            ...
            value: function(t, e, i) {
                ...
                this.size.left = o - .5 * this.size.width,
                this.size.top = n - .5 * this.size.height,
                this.size.yLine = n + .5 * (1 - this.lineCount) * this.fontOptions.size,
                "hanging" === r && (this.size.top += .5 * this.fontOptions.size, this.size.top += 4, this.size.yLine += 4)
            }
        },
        {
        ...
        },
        {
            ...
            value: function(t, e, i, o) {
                return new nl(t, this, e, i).process(o)
            }
        },
        {
            key: "_processLabel",
    ...
    al = It("Reflect", "construct"),
    hl = s((function() {
        function t() {}
        return ! (al((function() {}), [], t) instanceof t)
    })),
    dl = !s((function() {
        al((function() {}))
    })),
    ...
    },
    {
        construct: function(t, e) {
            ...
            var n = i.prototype,
            r = re(m(n) ? n: Object.prototype),
            s = Function.apply.call(t, r, e);
            return m(s) ? s: r
        }
    });
    var cl = F.Reflect.construct,
    ul = wo;
    q({
        target: "Object",
        stat: !0
    ...
    var fl = F.Object.setPrototypeOf,
    pl = o((function(t) {
        function e(i, o) {
            return t.exports = e = fl ||
            function(t, e) {
    ...
    var yl = function(t, e) {
        return ! e || "object" !== cr(e) && "function" != typeof e ? gl(t) : e
    },
    ml = gn,
    bl = o((function(t) {
        function e(i) {
            return t.exports = e = fl ? ml: function(t) {
                return t.__proto__ || ml(t)
            },
            e(i)
        }
        t.exports = e
    ...
    _l = function(t) {
        var e = t.fill;
        return t === kl || t instanceof Array && e === kl.fill ? wl: e
    },
    xl = function() {
        function t(e, i, o) {
            ed(this, t),
        ...
        },
        {
            ...
            value: function(t) {
                this.margin = {},
                this.options.margin && ("object" == cr(this.options.margin) ? (this.margin.top = this.options.margin.top, this.margin.right = this.options.margin.right, this.margin.bottom = this.options.margin.bottom, this.margin.left = this.options.margin.left) : (this.margin.top = this.options.margin, this.margin.right = this.options.margin, this.margin.bottom = this.options.margin, this.margin.left = this.options.margin)),
        ...
        },
        {
            ...
            value: function(t, e) {
                if (!1 !== e.borderDashes) if (void 0 !== t.setLineDash) {
                    var i = e.borderDashes; ! 0 === i && (i = [5, 15]),
                    t.setLineDash(i)
        ...
        },
        {
            ...
            value: function(t, e) { ! 1 !== e.borderDashes && (void 0 !== t.setLineDash ? t.setLineDash([0]) : (console.warn("setLineDash is not supported in this browser. The dashed borders cannot be used."), this.options.shapeProperties.borderDashes = !1, e.borderDashes = !1))
            }
        },
        {
            key: "needsRefresh",
        ...
        },
        {
            ...
            value: function(t, e) {
                var i = e.borderWidth / this.body.view.scale;
                t.save(),
                i > 0 && (this.enableBorderDashes(t, e), t.stroke(), this.disableBorderDashes(t, e)),
                t.restore()
            }
        },
        {
    ...
    function El(t) {
        var e = function() {
            if ("undefined" == typeof Reflect || !cl) return ! 1;
            if (cl.sham) return ! 1;
            if ("function" == typeof Proxy) return ! 0;
            try {
                return Date.prototype.toString.call(cl(Date, [], (function() {}))),
                !0
            } catch(t) {
                return ! 1
            }
    ...
    var Ol = function(t) {
        ...
        function i(t, o, n) {
            var r;
            return ed(this, i),
            (r = e.call(this, t, o, n))._setMargins(n),
            r
        }
        return od(i, [{
            key: "resize",
    ...
    var Sl = function(t) {
        ...
        function i(t, o, n) {
            var r;
            return ed(this, i),
            (r = e.call(this, t, o, n)).labelOffset = 0,
            r.selected = !1,
            r
        }
        return od(i, [{
        ...
        },
        {
            ...
            value: function() {
                ...
                if (this.options.imagePadding) {
                    ...
                    "object" == cr(e) ? (t.top = e.top, t.right = e.right, t.bottom = e.bottom, t.left = e.left) : (t.top = e, t.right = e, t.bottom = e, t.left = e)
                }
                return t
            }
        },
        {
            ...
            value: function() {
                ...
                if (!1 === this.options.shapeProperties.useImageSize) {
                    ...
                    e = 2 * this.options.size * o
                } else {
                    var n = this._getImagePadding();
                    t = this.imageObj.width + n.left + n.right,
                    e = this.imageObj.height + n.top + n.bottom
                }
                this.width = t,
                this.height = e,
        ...
        },
        {
            ...
            value: function(t, e) {
                if (0 != this.imageObj.width) {
                    ...
                    this.enableShadow(t, e);
                    var i = 1; ! 0 === this.options.shapeProperties.interpolation && (i = this.imageObj.width / this.width / this.body.view.scale);
        ...
        },
        {
            ...
            value: function(t, e, i, o, n) {
                ...
                this.labelModule.draw(t, e, a, o, n, "hanging")
            }
        }]),
        i
    } (xl);
    ...
    var Pl = function(t) {
        ...
        function i(t, o, n, r, s) {
            var a;
            return ed(this, i),
            (a = e.call(this, t, o, n)).setImages(r, s),
            a
        }
        return od(i, [{
            key: "resize",
        ...
        },
        {
            ...
            value: function(t, e, i, o, n, r) {
                ...
                var s = e,
                a = i;
                "top-left" === this.options.shapeProperties.coordinateOrigin ? (this.left = e, this.top = i, s += this.width / 2, a += this.height / 2) : (this.left = e - this.width / 2, this.top = i - this.height / 2),
        ...
        },
        {
            key: "updateBoundingBox",
            value: function(t, e) {
                "top-left" === this.options.shapeProperties.coordinateOrigin ? (this.boundingBox.top = e, this.boundingBox.left = t, this.boundingBox.right = t + 2 * this.options.size, this.boundingBox.bottom = e + 2 * this.options.size) : (this.boundingBox.top = e - this.options.size, this.boundingBox.left = t - this.options.size, this.boundingBox.right = t + this.options.size, this.boundingBox.bottom = e + this.options.size),
    ...
    var zl = function(t) {
        ...
        return od(i, [{
            ...
            value: function(t) {
                ...
                if (this.needsRefresh(e, i)) {
                    ...
                    var s = 2 * o.size;
                    this.width = null !== (n = this.customSizeWidth) && void 0 !== n ? n: s,
        ...
        },
        {
            ...
            value: function(t, e, i, o, n, r, s, a) {
                ...
                this.left = o - this.width / 2,
                this.top = n - this.height / 2,
                this.initContextForDraw(t, a),
                (h = e, Object.prototype.hasOwnProperty.call(Ot, h) ? Ot[h] : function(t) {
                    for (var e = arguments.length,
                    i = new Array(e > 1 ? e - 1 : 0), o = 1; o < e; o++) i[o - 1] = arguments[o];
                    CanvasRenderingContext2D.prototype[h].call(t, i)
                })(t, o, n, a.size),
                this.performFill(t, a),
                void 0 !== this.options.icon && void 0 !== this.options.icon.code && (t.font = (r ? "bold ": "") + this.height / 2 + "px " + (this.options.icon.face || "FontAwesome"), t.fillStyle = this.options.icon.color || "black", t.textAlign = "center", t.textBaseline = "middle", t.fillText(this.options.icon.code, o, n)),
                {
    ...
    function Bl(t, e) {
        ...
        if (Oi) {
            var o = Oi(t);
            e && (o = pn(o).call(o, (function(e) {
                return Wt(t, e).enumerable
            }))),
            i.push.apply(i, o)
        }
        return i
    ...
    function Fl(t) {
        for (var e = 1; e < arguments.length; e++) {
            ...
            if (e % 2) qo(i = Bl(Object(o), !0)).call(i, (function(e) {
                Eo(t, e, o[e])
            }));
            else if (At) Dt(t, At(o));
            else {
                var n;
                qo(n = Bl(Object(o))).call(n, (function(e) {
                    Tt(t, e, Wt(o, e))
                }))
            }
        }
    ...
    var Al = function(t) {
        ...
        function i(t, o, n, r) {
            var s;
            return ed(this, i),
            (s = e.call(this, t, o, n, r)).ctxRenderer = r,
            s
        }
        return od(i, [{
            key: "draw",
            value: function(t, e, i, o, n, r) {
                ...
                return s.nodeDimensions && (this.customSizeWidth = s.nodeDimensions.width, this.customSizeHeight = s.nodeDimensions.height),
                s
            }
        },
        {
    ...
    var Ul = function(t) {
        ...
        return od(i, [{
            ...
            value: function(t) {
                ...
                if (this.needsRefresh(e, i)) {
                    var o = this.getDimensionsFromLabel(t, e, i);
                    this.height = 2 * o.height,
                    this.width = o.width + o.height,
                    this.radius = .5 * this.width
                }
            }
        },
        {
            ...
            value: function(t, e, i, o, n, r) {
                ...
                this.initContextForDraw(t, r),
                _t(t, this.left, this.top, this.width, this.height),
                this.performFill(t, r),
                this.updateBoundingBox(e, i, t, o, n),
    ...
    var Xl = function(t) {
        ...
        },
        {
            ...
            value: function(t, e, i, o, n, r) {
                var s = this;
                return this.resize(t, o, n),
                this.options.icon.size = this.options.icon.size || 50,
                this.left = e - this.width / 2,
                this.top = i - this.height / 2,
                this._icon(t, e, i, o, n, r),
                {
                    drawExternalLabel: function() {
    ...
    var Kl = function(t) {
        ...
        },
        {
            ...
            value: function(t, e, i, o, n, r) {
                ...
                if ("top-left" === this.options.shapeProperties.coordinateOrigin ? (this.left = e, this.top = i, s += this.width / 2, a += this.height / 2) : (this.left = e - this.width / 2, this.top = i - this.height / 2), !0 === this.options.shapeProperties.useBorderWithImage) {
                    ...
                    t.lineWidth = Math.min(this.width, l),
                    t.beginPath();
                    ...
                    void 0 !== r.opacity && (c = Vr(c, r.opacity), u = Vr(u, r.opacity)),
                    t.strokeStyle = c,
                    t.fillStyle = u,
        ...
        },
        {
            ...
            value: function(t, e) {
                this.resize(),
                "top-left" === this.options.shapeProperties.coordinateOrigin ? (this.left = t, this.top = e) : (this.left = t - this.width / 2, this.top = e - this.height / 2),
                this.boundingBox.left = this.left,
                this.boundingBox.top = this.top,
                this.boundingBox.bottom = this.top + this.height,
                this.boundingBox.right = this.left + this.width,
    ...
    uc = function(t, e, i) {
        var o = i.charAt(e - 1),
        n = i.charAt(e + 1);
        return lc.test(t) && !cc.test(n) || cc.test(t) && !lc.test(o) ? "\\u" + t.charCodeAt(0).toString(16) : t
    },
    fc = s((function() {
        return '"\\udf06\\ud834"' !== hc("\udf06\ud834") || '"\\udead"' !== hc("\udead")
    }));
    ...
    {
        stringify: function(t, e, i) {
            var o = hc.apply(null, arguments);
            return "string" == typeof o ? o.replace(dc, uc) : o
        }
    }),
    F.JSON || (F.JSON = {
        stringify: JSON.stringify
    });
    var pc, vc = function(t, e, i) {
        return F.JSON.stringify.apply(null, arguments)
    },
    gc = !1,
    yc = "background: #FFeeee; color: #dd0000",
    mc = function() {
        function t() {
            ed(this, t)
        }
        ...
        },
        {
            ...
            value: function(e, i, o, n, r, s) {
                var a = function(i) {
                    console.error("%c" + i + t.printLocation(s, e), yc)
                },
                h = t.getType(i[e]),
                d = r[h];
                void 0 !== d ? "array" === t.getType(d) && -1 === On(d).call(d, i[e]) ? (a('Invalid option detected in "' + e + '". Allowed values are:' + t.print(d) + ' not "' + i[e] + '". '), gc = !0) : "object" === h && "__any__" !== n && (s = Rr(s, e), t.parse(i[e], o[n], s)) : void 0 === r.any && (a('Invalid type received for "' + e + '". Expected: ' + t.print(ir(r)) + ". Received [" + h + '] "' + i[e] + '"'), gc = !0)
            }
        },
        {
            key: "getType",
            value: function(t) {
                var e = cr(t);
                return "object" === e ? null === t ? "null": t instanceof Boolean ? "boolean": t instanceof Number ? "number": t instanceof String ? "string": dr(t) ? "array": t instanceof Date ? "date": void 0 !== t.nodeType ? "dom": !0 === t._isAMomentObject ? "moment": "object": "number" === e ? "number": "boolean" === e ? "boolean": "string" === e ? "string": void 0 === e ? "undefined": e
            }
        },
        {
            key: "getSuggestion",
            value: function(e, i, o) {
                var n, r = t.findInOptions(e, i, o, !1),
                s = t.findInOptions(e, pc, [], !0);
                n = void 0 !== r.indexMatch ? " in " + t.printLocation(r.path, e, "") + 'Perhaps it was incomplete? Did you mean: "' + r.indexMatch + '"?\n\n': s.distance <= 4 && r.distance > s.distance ? " in " + t.printLocation(r.path, e, "") + "Perhaps it was misplaced? Matching option found at: " + t.printLocation(s.path, s.closestMatch, "") : r.distance <= 8 ? '. Did you mean "' + r.closestMatch + '"?' + t.printLocation(r.path, e) : ". Did you mean one of these: " + t.print(ir(i)) + t.printLocation(o, e),
                console.error('%cUnknown option detected: "' + e + '"' + n, yc),
                gc = !0
            }
        },
        {
            ...
            value: function(e, i, o) {
                ...
                for (var l in i) {
                    ...
                    if (void 0 !== i[l].__type__ && !0 === n) {
                        var u = t.findInOptions(e, i[l], Rr(o, l));
                        r > u.distance && (s = u.closestMatch, a = u.path, r = u.distance, d = u.indexMatch)
                    } else {
                        var f; - 1 !== On(f = l.toLowerCase()).call(f, h) && (d = l),
                        r > (c = t.levenshteinDistance(e, l)) && (s = l, a = jr(o), r = c)
                    }
                }
                return {
                    closestMatch: s,
        ...
        },
        {
            key: "print",
            value: function(t) {
                return vc(t).replace(/(")|(\[)|(\])|(,"__type__")/g, "").replace(/(,)/g, ", ")
            }
        },
        {
    ...
    function wc(t) {
        for (var e = 1; e < arguments.length; e++) {
            var i, o = null != arguments[e] ? arguments[e] : {};
            if (e % 2) qo(i = bc(Object(o), !0)).call(i, (function(e) {
                Eo(t, e, o[e])
            }));
            else if (At) Dt(t, At(o));
            else {
                var n;
                qo(n = bc(Object(o))).call(n, (function(e) {
                    Tt(t, e, Wt(o, e))
                }))
            }
        }
    ...
    var kc = function() {
        function t(e, i, o, n, r, s) {
            ...
            this.selected = !1,
            this.hover = !1,
            this.labelModule = new sl(this.body, this.options, !1),
            this.setOptions(e)
        }
        return od(t, [{
            key: "attachEdge",
            value: function(t) {
                var e; - 1 === On(e = this.edges).call(e, t) && this.edges.push(t)
            }
        },
        {
            key: "detachEdge",
            value: function(t) {
                var e, i, o = On(e = this.edges).call(e, t); - 1 != o && ls(i = this.edges).call(i, o, 1)
            }
        },
        {
            key: "setOptions",
            value: function(e) {
                ...
                if (e) {
                    ...
                    void 0 !== e.x && (null === e.x ? (this.x = void 0, this.predefinedPosition = !1) : (this.x = Ko(e.x), this.predefinedPosition = !0)),
                    void 0 !== e.y && (null === e.y ? (this.y = void 0, this.predefinedPosition = !1) : (this.y = Ko(e.y), this.predefinedPosition = !0)),
                    void 0 !== e.size && (this.baseSize = e.size),
                    void 0 !== e.value && (e.value = Yd(e.value)),
                    t.parseOptions(this.options, e, !0, this.globalOptions, this.grouplist);
                    var o = [e, this.options, this.defaultOptions];
                    return this.chooser = Xd("node", o),
                    this._load_images(),
        ...
        },
        {
            ...
            value: function() {
                ...
                if (this.selected || this.hover ? !0 === this.chooser ? this.selected ? (null != this.options.borderWidthSelected ? t.borderWidth = this.options.borderWidthSelected: t.borderWidth *= 2, t.color = this.options.color.highlight.background, t.borderColor = this.options.color.highlight.border, t.shadow = this.options.shadow.enabled) : this.hover && (t.color = this.options.color.hover.background, t.borderColor = this.options.color.hover.border, t.shadow = this.options.shadow.enabled) : "function" == typeof this.chooser && (this.chooser(t, this.options.id, this.selected, this.hover), !1 === t.shadow && (t.shadowColor === this.options.shadow.color && t.shadowSize === this.options.shadow.size && t.shadowX === this.options.shadow.x && t.shadowY === this.options.shadow.y || (t.shadow = !0))) : t.shadow = this.options.shadow.enabled, void 0 !== this.options.opacity) {
                    ...
                    t.borderColor = Vr(t.borderColor, e),
                    t.color = Vr(t.color, e),
                    t.shadowColor = Vr(t.shadowColor, e)
                }
                return t
            }
        },
        {
            ...
            value: function(e) {
                ...
                t.updateGroupOptions(this.options, wc(wc({},
                e), {},
                {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                case "box":
                    this.shape = new Ol(this.options, this.body, this.labelModule);
                    break;
                case "circle":
                    this.shape = new Ml(this.options, this.body, this.labelModule);
                    break;
                case "circularImage":
                    this.shape = new Pl(this.options, this.body, this.labelModule, this.imageObj, this.imageObjAlt);
                    break;
                case "custom":
                    this.shape = new Al(this.options, this.body, this.labelModule, this.options.ctxRenderer);
                    break;
                case "database":
                    this.shape = new jl(this.options, this.body, this.labelModule);
                    break;
                case "diamond":
                    this.shape = new Hl(this.options, this.body, this.labelModule);
                    break;
                case "dot":
                    this.shape = new Vl(this.options, this.body, this.labelModule);
                    break;
                case "ellipse":
                    this.shape = new Ul(this.options, this.body, this.labelModule);
                    break;
                case "icon":
                    this.shape = new Xl(this.options, this.body, this.labelModule);
                    break;
                case "image":
                    this.shape = new Kl(this.options, this.body, this.labelModule, this.imageObj, this.imageObjAlt);
                    break;
                case "square":
                ...
                case "hexagon":
                    ...
                    break;
                case "star":
                    this.shape = new ec(this.options, this.body, this.labelModule);
                    break;
                case "text":
                    this.shape = new oc(this.options, this.body, this.labelModule);
                    break;
                case "triangle":
                    this.shape = new rc(this.options, this.body, this.labelModule);
                    break;
                case "triangleDown":
                    this.shape = new ac(this.options, this.body, this.labelModule);
                    break;
                default:
                    this.shape = new Ul(this.options, this.body, this.labelModule)
                }
        ...
        },
        {
            ...
            value: function(t) {
                var e = [];
                return this.labelModule.visible() && Gd(this.labelModule.getSize(), t) && e.push({
                    nodeId: this.id,
                    labelId: 0
                }),
                Gd(this.shape.boundingBox, t) && e.push({
                    nodeId: this.id
                }),
                e
            }
            ...
            value: function(e, i, o) {
                ...
                if (void 0 !== o) {
                    ...
                    if ("number" == typeof r || "string" == typeof r && "" != r) {
                        ...
                        var a = pn(n = Wd(i)).call(n, (function(t) {
                            return null != i[t]
                        }));
                        a.push("font"),
                        Nr(a, e, s),
        ...
        },
        {
            ...
            value: function(e, i) {
                ...
                if (Nr(s, e, i, o), t.checkMass(i), void 0 !== e.opacity && (t.checkOpacity(e.opacity) || (console.error("Invalid option for node opacity. Value must be between 0 and 1, found: " + e.opacity), e.opacity = void 0)), void 0 !== i.opacity && (t.checkOpacity(i.opacity) || (console.error("Invalid option for node opacity. Value must be between 0 and 1, found: " + i.opacity), i.opacity = void 0)), i.shapeProperties && !t.checkCoordinateOrigin(i.shapeProperties.coordinateOrigin) && console.error("Invalid option for node coordinateOrigin, found: " + i.shapeProperties.coordinateOrigin), Jr(e, i, "shadow", n), void 0 !== i.color && null !== i.color) {
                    var a = Ur(i.color);
                    Br(e.color, a)
                } else ! 0 === o && null === i.color && (e.color = Qr(n.color));
                void 0 !== i.fixed && null !== i.fixed && ("boolean" == typeof i.fixed ? (e.fixed.x = i.fixed, e.fixed.y = i.fixed) : (void 0 !== i.fixed.x && "boolean" == typeof i.fixed.x && (e.fixed.x = i.fixed.x), void 0 !== i.fixed.y && "boolean" == typeof i.fixed.y && (e.fixed.y = i.fixed.y))),
                !0 === o && null === i.font && (e.font = Qr(n.font)),
                t.updateGroupOptions(e, i, r),
                void 0 !== i.scaling && Jr(e.scaling, i.scaling, "label", n.scaling)
            }
        },
        {
            key: "checkMass",
            value: function(t, e) {
                if (void 0 !== t.mass && t.mass <= 0) {
                    ...
                    console.error("%cNegative or zero mass disallowed" + i + ", setting mass to 1.", yc),
                    t.mass = 1
                }
            }
        }]),
    ...
    function _c(t, e) {
        ...
        if (void 0 === wr || null == ro(t)) {
            if (dr(t) || (i = function(t, e) {
                ...
                "Object" === o && t.constructor && (o = t.constructor.name);
                if ("Map" === o || "Set" === o) return mo(t);
                if ("Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return xc(t, e)
            } (t)) || e && t && "number" == typeof t.length) {
                i && (t = i);
                var o = 0,
                n = function() {};
    ...
    function xc(t, e) { (null == e || e > t.length) && (e = t.length);
        for (var i = 0,
        o = new Array(e); i < e; i++) o[i] = t[i];
        return o
    }
    var Ec = function() {
        function t(e, i, o, n) {
            var r, s = this;
            if (ed(this, t), this.body = e, this.images = i, this.groups = o, this.layoutEngine = n, this.body.functions.createNode = Q(r = this.create).call(r, this), this.nodesListeners = {
                add: function(t, e) {
                    s.add(e.items)
                },
                update: function(t, e) {
        ...
        return od(t, [{
            ...
            value: function() {
                var t, e, i = this;
                this.body.emitter.on("refreshNodes", Q(t = this.refresh).call(t, this)),
                this.body.emitter.on("refresh", Q(e = this.refresh).call(e, this)),
                this.body.emitter.on("destroy", (function() {
                    Hr(i.nodesListeners, (function(t, e) {
        ...
        },
        {
            ...
            value: function(t) {
                if (void 0 !== t) {
                    if (kc.parseOptions(this.options, t), void 0 !== t.opacity && (Rd(t.opacity) || !Ad(t.opacity) || t.opacity < 0 || t.opacity > 1 ? console.error("Invalid option for node opacity. Value must be between 0 and 1, found: " + t.opacity) : this.options.opacity = t.opacity), void 0 !== t.shape) for (var e in this.body.nodes) Object.prototype.hasOwnProperty.call(this.body.nodes, e) && this.body.nodes[e].updateShape();
                    if (void 0 !== t.font || void 0 !== t.widthConstraint || void 0 !== t.heightConstraint) for (var i = 0,
                    o = ir(this.body.nodes); i < o.length; i++) {
                        var n = o[i];
                        this.body.nodes[n].updateLabelModule(),
        ...
        },
        {
            ...
            value: function(t) {
                ...
                this.layoutEngine.positionInitially(o),
                !1 === i && this.body.emitter.emit("_dataChanged")
            }
        },
        {
            ...
            value: function(t, e, i) {
                ...
                n || void 0 === i || (n = Bd(e).call(e, (function(t, e) {
                    var o = i[e];
        ...
        },
        {
            key: "create",
            value: function(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : kc;
        ...
        },
        {
            ...
            value: function() {
                ...
                Hr(this.body.nodes, (function(i, o) {
        ...
        },
        {
            ...
            value: function(t, e, i) {
                var o = this;
                void 0 !== this.body.nodes[t] ? (this.body.nodes[t].x = Number(e), this.body.nodes[t].y = Number(i), Td((function() {
    ...
    },
    {
        get: function t(e, i) {
            ...
            return R(e) === r ? e[i] : (o = S.f(e, i)) ? k(o, "value") ? o.value: void 0 === o.get ? void 0 : o.get.call(r) : m(n = Di(e)) ? t(n, i, r) : void 0
        }
    });
    var Cc = F.Reflect.get;
    var Sc = function(t, e) {
    ...
    Tc = o((function(t) {
        function e(i, o, n) {
            return "undefined" != typeof Reflect && Cc ? t.exports = e = Cc: t.exports = e = function(t, e, i) {
                var o = Sc(t, e);
                if (o) {
                    var n = Oc(o, e);
    ...
    },
    {
        hypot: function(t, e) {
            ...
            r = 0,
            s = arguments.length,
            a = 0; r < s;) a < (i = Dc(arguments[r++])) ? (n = n * (o = a / i) * o + 1, a = i) : n += i > 0 ? (o = i / a) * o: i;
            return a === 1 / 0 ? 1 / 0 : a * Pc(n)
        }
    });
    var zc = F.Math.hypot;
    function Bc(t) {
    ...
    jc = function() {
        ...
        return od(t, null, [{
            ...
            value: function(t, e) {
                ...
                r = e.angle + o / 2;
                return t.beginPath(),
                t.arc(i.x, i.y, .4 * e.length, n, r, !1),
                t.stroke(),
                !0
            }
        }]),
    ...
    function $c(t) {
        for (var e = 1; e < arguments.length; e++) {
            var i, o = null != arguments[e] ? arguments[e] : {};
            if (e % 2) qo(i = Kc(Object(o), !0)).call(i, (function(e) {
                Eo(t, e, o[e])
            }));
            else if (At) Dt(t, At(o));
            else {
                var n;
                qo(n = Kc(Object(o))).call(n, (function(e) {
                    Tt(t, e, Wt(o, e))
                }))
            }
        }
    ...
    var Zc = function() {
        ...
        },
        {
            ...
            value: function(t, e, i, o) {
                ...
                t.lineWidth = e.width,
                !1 !== e.dashes ? this._drawDashedLine(t, e, n) : this._drawLine(t, e, n)
            }
        },
        {
            key: "_drawLine",
        ...
        },
        {
            ...
            value: function(t, e, i, o, n) {
                t.lineCap = "round";
                var r = dr(e.dashes) ? e.dashes: [5, 5];
                if (void 0 !== t.setLineDash) {
                    ...
                    if (this.from != this.to) Et(t, this.from.x, this.from.y, this.to.x, this.to.y, r);
                    else {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                var e, i = ur(e = this._getCircleData(t)).call(e, 0, 2),
                o = Jn(i, 2),
                n = o[0],
                r = o[1];
                return {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                var i = $d(t, this.options.selfReference.angle, e, this.from);
                return [i.x, i.y, e]
            }
        },
        {
        ...
        },
        {
            ...
            value: function(t, e, i) {
                ...
                l = .5 * (s + a),
                c = 0; ! 0 === this.options.arrowStrikethrough && ( - 1 === h ? c = this.options.endPointOffset.from: 1 === h && (c = this.options.endPointOffset.to));
                var u = 0;
                do {
            ...
            value: function(t, e) {
                if (!1 !== e.inheritsColor) {
                    if ("both" === e.inheritsColor && this.from.id !== this.to.id) {
                        ...
                        return ! 1 === this.from.selected && !1 === this.to.selected ? (o = Vr(this.from.options.color.border, e.opacity), n = Vr(this.to.options.color.border, e.opacity)) : !0 === this.from.selected && !1 === this.to.selected ? n = this.to.options.color.border: !1 === this.from.selected && !0 === this.to.selected && (o = this.from.options.color.border),
                        i.addColorStop(0, o),
                        i.addColorStop(1, n),
                        i
                    }
                    return "to" === e.inheritsColor ? Vr(this.to.options.color.border, e.opacity) : Vr(this.from.options.color.border, e.opacity)
                }
                return Vr(e.color, e.opacity)
            }
        },
        {
            key: "_circle",
            value: function(t, e, i, o, n) {
                ...
                if (!this.options.selfReference.renderBehindTheNode) {
                    ...
                    r = Math.atan2(d.y - o, d.x - i),
                    s = Math.atan2(l.y - o, l.x - i)
                }
                t.beginPath(),
                t.arc(i, o, n, r, s, !1),
                t.stroke(),
            ...
            value: function(t, e, i, o, n, r) {
                ...
                if (h != d) {
                    ...
                    if ("middle" !== e) if (!0 === this.options.smooth.enabled) {
                        ...
                        a = g
                    } else s = Math.atan2(h.y - d.y, h.x - d.x),
                    ...
                    var k = this._getCircleData(t),
                    _ = Jn(k, 3),
                    x = _[0],
                    E = _[1],
                    O = _[2];
                    if ("from" === e) {
                        var C = this.options.selfReference.angle,
                        S = this.options.selfReference.angle + Math.PI,
                        T = this._findBorderPositionCircle(this.from, t, {
                            x: x,
                            y: E,
                            low: C,
                            high: S,
                        ...
                        s = -2 * T.t * Math.PI + 1.5 * Math.PI + .1 * Math.PI,
                        a = T
                    } else if ("to" === e) {
                        var M = this.options.selfReference.angle,
                        ...
                        a = this._pointOnCircle(x, E, O, I),
                        s = -2 * I * Math.PI + 1.5 * Math.PI + .1 * Math.PI
                    }
                }
                return {
                    point: a,
        ...
        },
        {
            ...
            value: function(t, e, i, o, n) {
                ...
                t.lineWidth = e.width,
                Gc.draw(t, n) && (this.enableShadow(t, e), _l(t).call(t), this.disableShadow(t, e))
            }
        },
        {
            key: "enableShadow",
            value: function(t, e) { ! 0 === e.shadow && (t.shadowColor = e.shadowColor, t.shadowBlur = e.shadowSize, t.shadowOffsetX = e.shadowX, t.shadowOffsetY = e.shadowY)
            }
        },
        {
            key: "disableShadow",
            value: function(t, e) { ! 0 === e.shadow && (t.shadowColor = "rgba(0,0,0,0)", t.shadowBlur = 0, t.shadowOffsetX = 0, t.shadowOffsetY = 0)
            }
        },
        {
            key: "drawBackground",
    ...
    function Jc(t) {
        for (var e = 1; e < arguments.length; e++) {
            var i, o = null != arguments[e] ? arguments[e] : {};
            if (e % 2) qo(i = Qc(Object(o), !0)).call(i, (function(e) {
                Eo(t, e, o[e])
            }));
            else if (At) Dt(t, At(o));
            else {
                var n;
                qo(n = Qc(Object(o))).call(n, (function(e) {
                    Tt(t, e, Wt(o, e))
                }))
            }
        }
    ...
    var eu = function(t) {
        ...
        return od(i, [{
            ...
            value: function(t, e) {
                var i, o, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this._getViaCoordinates(),
                r = 10,
                s = .2,
                a = !1,
                h = 1,
                ...
                t.id === this.from.id && (l = this.from, a = !0, c = this.options.endPointOffset ? this.options.endPointOffset.from: 0),
        ...
        },
        {
            ...
            value: function(t, e, i, o, n, r, s) {
                ...
                f = t,
                p = e;
                for (h = 1; h < 10; h++) d = .1 * h,
                l = Math.pow(1 - d, 2) * t + 2 * d * (1 - d) * s.x + Math.pow(d, 2) * i,
    ...
    var ou = function(t) {
        ...
        return od(i, [{
            key: "setOptions",
            value: function(t) {
                Tc(bl(i.prototype), "setOptions", this).call(this, t);
                var e = !1;
    ...
    var hu = function(t) {
        ...
        },
        {
            key: "_getViaCoordinates",
            value: function() {
                var t, e, i, o, n = this.from.x - this.to.x,
                r = this.from.y - this.to.y,
    ...
    cu = function() {
        function t(e, i, o, n, r) {
            if (ed(this, t), void 0 === i) throw new Error("No body provided");
            this.options = Qr(n),
            ...
            this.connected = !1,
            this.labelModule = new sl(this.body, this.options, !0),
            this.setOptions(e)
        }
        return od(t, [{
            key: "setOptions",
        ...
        },
        {
            ...
            value: function() {
                ...
                else n.shadow = this.options.shadow.enabled,
                n.width = Math.max(n.width, .3 / this.body.view.scale);
                return n
            }
        },
        ...
        },
        {
            ...
            value: function() {
                ...
                e = !1,
                i = !0;
                return void 0 !== this.edgeType && ((this.edgeType instanceof ou && !0 === t.enabled && "dynamic" === t.type || this.edgeType instanceof hu && !0 === t.enabled && "cubicBezier" === t.type || this.edgeType instanceof ru && !0 === t.enabled && "dynamic" !== t.type && "cubicBezier" !== t.type || this.edgeType instanceof lu && !1 === t.type.enabled) && (i = !1), !0 === i && (e = this.cleanup())),
        ...
        },
        {
            ...
            value: function() {
                ...
                !0 === this.connected ? (this.from.attachEdge(this), this.to.attachEdge(this)) : (this.from && this.from.detachEdge(this), this.to && this.to.detachEdge(this)),
        ...
        },
        {
            ...
            value: function(t) {
                ...
                if (!e.hidden) {
                    ...
                    e.fromArrow && (o.from = this.edgeType.getArrowData(t, "from", i, this.selected, this.hover, e), !1 === e.arrowStrikethrough && (this.edgeType.fromPoint = o.from.core), e.fromArrowSrc && (o.from.image = this.imagelist.load(e.fromArrowSrc)), e.fromArrowImageWidth && (o.from.imageWidth = e.fromArrowImageWidth), e.fromArrowImageHeight && (o.from.imageHeight = e.fromArrowImageHeight)),
                    e.toArrow && (o.to = this.edgeType.getArrowData(t, "to", i, this.selected, this.hover, e), !1 === e.arrowStrikethrough && (this.edgeType.toPoint = o.to.core), e.toArrowSrc && (o.to.image = this.imagelist.load(e.toArrowSrc)), e.toArrowImageWidth && (o.to.imageWidth = e.toArrowImageWidth), e.toArrowImageHeight && (o.to.imageHeight = e.toArrowImageHeight)),
                    e.middleArrow && (o.middle = this.edgeType.getArrowData(t, "middle", i, this.selected, this.hover, e), e.middleArrowSrc && (o.middle.image = this.imagelist.load(e.middleArrowSrc)), e.middleArrowImageWidth && (o.middle.imageWidth = e.middleArrowImageWidth), e.middleArrowImageHeight && (o.middle.imageHeight = e.middleArrowImageHeight)),
            ...
            value: function(t, e) {
                if (void 0 !== this.options.label) {
                    ...
                    if (this.labelModule.differentState(this.selected, this.hover) && this.labelModule.getTextSize(t, this.selected, this.hover), o.id != n.id) {
                        ...
                        var s = $d(t, this.options.selfReference.angle, this.options.selfReference.size, o);
        ...
        },
        {
            ...
            value: function(t) {
                ...
                if (this.labelModule.visible()) {
                    ...
                    Gd(this.labelModule.getSize(), t, i) && e.push({
                        edgeId: this.id,
                        labelId: 0
                    })
                }
        ...
        },
        {
            ...
            value: function(t, e) {
                ...
                if (void 0 !== e.color && null !== e.color) {
                    ...
                    h = t.color;
                    if (n) Ar(h, o.color, !1, i);
                    else for (var d in h) Object.prototype.hasOwnProperty.call(h, d) && delete h[d];
                    if (Pr(h)) h.color = h,
                    h.highlight = h,
                    h.hover = h,
                    h.inherit = !1,
                    void 0 === a.opacity && (h.opacity = 1);
                    else {
                        var l = !1;
                        void 0 !== a.color && (h.color = a.color, l = !0),
                        void 0 !== a.highlight && (h.highlight = a.highlight, l = !0),
                        void 0 !== a.hover && (h.hover = a.hover, l = !0),
                        void 0 !== a.inherit && (h.inherit = a.inherit),
                        void 0 !== a.opacity && (h.opacity = Math.min(1, Math.max(0, a.opacity))),
                        !0 === l ? h.inherit = !1 : void 0 === h.inherit && (h.inherit = "from")
                    }
                } else ! 0 === i && null === e.color && (t.color = Qr(o.color)); ! 0 === i && null === e.font && (t.font = Qr(o.font)),
                Object.prototype.hasOwnProperty.call(e, "selfReferenceSize") && (console.warn("The selfReferenceSize property has been deprecated. Please use selfReference property instead. The selfReference can be set like thise selfReference:{size:30, angle:Math.PI / 4}"), t.selfReference.size = e.selfReferenceSize)
            }
        }]),
        t
    } (),
    uu = function() {
        function t(e, i, o) {
            ...
            this.images = i,
            this.groups = o,
            this.body.functions.createEdge = Q(n = this.create).call(n, this),
            this.edgesListeners = {
                add: function(t, e) {
                    r.add(e.items)
                },
            ...
            Ar(this.options, this.defaultOptions),
            this.bindEventListeners()
        }
        return od(t, [{
            key: "bindEventListeners",
            value: function() {
                ...
                this.body.emitter.on("refreshEdges", Q(t = this.refresh).call(t, this)),
                this.body.emitter.on("refresh", Q(e = this.refresh).call(e, this)),
                this.body.emitter.on("destroy", (function() {
                    Hr(i.edgesListeners, (function(t, e) {
        ...
        },
        {
            ...
            value: function(t) {
                if (void 0 !== t) {
                    cu.parseOptions(this.options, t, !0, this.defaultOptions, !0);
                    var e = !1;
        ...
        },
        {
            ...
            value: function(t) {
                ...
                else if (dr(t)) this.body.data.edges = new e.DataSet,
                this.body.data.edges.add(t);
                else {
                    if (t) throw new TypeError("Array or DataSet expected");
                    this.body.data.edges = new e.DataSet
                }
                if (n && Hr(this.edgesListeners, (function(t, e) {
                    n.off(e, t)
                })), this.body.edges = {},
                this.body.data.edges) {
                    Hr(this.edgesListeners, (function(t, e) {
                ...
                !1 === o && this.body.emitter.emit("_dataChanged")
            }
        },
        {
            key: "add",
        ...
        },
        {
            ...
            value: function() {
                var t = this;
                Hr(this.body.edges, (function(e, i) {
        ...
        },
        {
            key: "create",
            value: function(t) {
                return new cu(t, this.body, this.images, this.options, this.defaultOptions)
            }
        },
        {
            key: "reconnectEdges",
        ...
        },
        {
            ...
            value: function() {
                var t = this,
                e = [];
                Hr(this.body.edges, (function(i, o) {
    ...
    fu = function() {
        function t(e, i, o) {
            ...
            this.barnesHutTree,
            this.setOptions(o),
            this._rng = xr("BARNES HUT SOLVER")
        }
        return od(t, [{
            key: "setOptions",
            value: function(t) {
        ...
        },
        {
            ...
            value: function(t, e, i, o, n) {
                0 === t && (e = t = .1),
                this.overlapAvoidanceFactor < 1 && o.shape.radius && (t = Math.max(.1 + this.overlapAvoidanceFactor * o.shape.radius, t - o.shape.radius));
        ...
        },
        {
            ...
            value: function(t, e) {
                ...
                n = t[e[0]].x, r = t[e[0]].y, s = t[e[0]].x, a = t[e[0]].y, h = 1; h < o; h++) {
                    var d = t[e[h]],
                    l = d.x,
                    c = d.y;
        ...
        },
        {
            ...
            value: function(t) {
                var e = null;
                1 === t.childrenCount && (e = t.children.data, t.mass = 0, t.centerOfMass.x = 0, t.centerOfMass.y = 0),
                t.childrenCount = 4,
        ...
        },
        {
            ...
            value: function(t, e, i) {
                void 0 === i && (i = "#FF0000"),
                4 === t.childrenCount && (this._drawBranch(t.children.NW, e), this._drawBranch(t.children.NE, e), this._drawBranch(t.children.SE, e), this._drawBranch(t.children.SW, e)),
                e.strokeStyle = i,
                e.beginPath(),
    ...
    pu = function() {
        ...
        },
        {
            key: "solve",
            value: function() {
                for (var t, e, i, o, n, r, s, a, h = this.body.nodes,
                ...
                f = 0; f < d.length - 1; f++) {
                    s = h[d[f]];
                    for (var p = f + 1; p < d.length; p++) t = (a = h[d[p]]).x - s.x,
                    e = a.y - s.y,
                    0 === (i = Math.sqrt(t * t + e * e)) && (t = i = .1 * this._rng()),
                    i < 2 * c && (r = i < .5 * c ? 1 : u * i + 1.3333333333333333, o = t * (r /= i), n = e * r, l[s.id].x -= o, l[s.id].y -= n, l[a.id].x += o, l[a.id].y += n)
                }
            }
        }]),
        t
    ...
    gu = function() {
        ...
        },
        {
            key: "solve",
            value: function() {
                for (var t, e, i, o, n, r = this.physicsBody.physicsEdgeIndices,
                s = this.body.edges,
        ...
        },
        {
            ...
            value: function(t, e, i) {
                ...
                a = o * s,
                h = n * s;
                void 0 !== this.physicsBody.forces[t.id] && (this.physicsBody.forces[t.id].x += a, this.physicsBody.forces[t.id].y += h),
                void 0 !== this.physicsBody.forces[e.id] && (this.physicsBody.forces[e.id].x -= a, this.physicsBody.forces[e.id].y -= h)
            }
        }]),
        t
    } (),
    yu = function() {
        ...
        },
        {
            key: "solve",
            value: function() {
                for (var t, e, i, o, n, r, s, a, h, d, l = this.body.edges,
                c = .5,
                u = this.physicsBody.physicsEdgeIndices,
                f = this.physicsBody.physicsNodeIndices,
                p = this.physicsBody.forces,
                v = 0; v < f.length; v++) {
                    var g = f[v];
                    p[g].springFx = 0,
                    p[g].springFy = 0
    ...
    mu = function() {
        ...
        },
        {
            key: "solve",
            value: function() {
                for (var t, e, i, o, n = this.body.nodes,
                r = this.physicsBody.physicsNodeIndices,
                s = this.physicsBody.forces,
                a = 0; a < r.length; a++) {
                    t = -(o = n[r[a]]).x,
                    e = -o.y,
                    i = Math.sqrt(t * t + e * e),
                    this._calculateForces(i, t, e, s, o)
                }
            }
        },
        {
    ...
    var wu = function(t) {
        ...
        function i(t, o, n) {
            var r;
            return ed(this, i),
            (r = e.call(this, t, o, n))._rng = xr("FORCE ATLAS 2 BASED REPULSION SOLVER"),
            r
        }
        return od(i, [{
            key: "_calculateForces",
            value: function(t, e, i, o, n) {
                ...
                this.physicsBody.forces[o.id].y += h
            }
        }]),
        i
    } (fu);
    ...
    Eu = function() {
        ...
        return od(t, [{
            ...
            value: function() {
                ...
                this.body.emitter.on("startSimulation", (function() { ! 0 === t.ready && t.startSimulation()
                })),
        ...
        },
        {
            key: "setOptions",
            value: function(t) {
                if (void 0 !== t) if (!1 === t) this.options.enabled = !1,
                this.physicsEnabled = !1,
                this.stopSimulation();
                else if (!0 === t) this.options.enabled = !0,
                this.physicsEnabled = !0,
                this.startSimulation();
                else {
                    this.physicsEnabled = !0,
                    Nr(["stabilization"], this.options, t),
                    Jr(this.options, t, "stabilization"),
                    ...
                    e && (("number" != typeof e.x || Rd(e.x)) && (e.x = 0), ("number" != typeof e.y || Rd(e.y)) && (e.y = 0)),
        ...
        },
        {
            ...
            value: function() {
                var t;
                "forceAtlas2Based" === this.options.solver ? (t = this.options.forceAtlas2Based, this.nodesSolver = new wu(this.body, this.physicsBody, t), this.edgesSolver = new gu(this.body, this.physicsBody, t), this.gravitySolver = new xu(this.body, this.physicsBody, t)) : "repulsion" === this.options.solver ? (t = this.options.repulsion, this.nodesSolver = new pu(this.body, this.physicsBody, t), this.edgesSolver = new gu(this.body, this.physicsBody, t), this.gravitySolver = new mu(this.body, this.physicsBody, t)) : "hierarchicalRepulsion" === this.options.solver ? (t = this.options.hierarchicalRepulsion, this.nodesSolver = new vu(this.body, this.physicsBody, t), this.edgesSolver = new yu(this.body, this.physicsBody, t), this.gravitySolver = new mu(this.body, this.physicsBody, t)) : (t = this.options.barnesHut, this.nodesSolver = new fu(this.body, this.physicsBody, t), this.edgesSolver = new gu(this.body, this.physicsBody, t), this.gravitySolver = new mu(this.body, this.physicsBody, t)),
                this.modelOptions = t
            }
        },
        {
            key: "initPhysics",
            value: function() { ! 0 === this.physicsEnabled && !0 === this.options.enabled ? !0 === this.options.stabilization.enabled ? this.stabilize() : (this.stabilized = !1, this.ready = !0, this.body.emitter.emit("fit", {},
        ...
        },
        {
            key: "startSimulation",
            value: function() {
                var t; ! 0 === this.physicsEnabled && !0 === this.options.enabled ? (this.stabilized = !1, this.adaptiveTimestep = !1, this.body.emitter.emit("_resizeNodes"), void 0 === this.viewFunction && (this.viewFunction = Q(t = this.simulationStep).call(t, this), this.body.emitter.on("initRedraw", this.viewFunction), this.body.emitter.emit("_startRendering"))) : this.body.emitter.emit("_redraw")
            }
        },
        {
            key: "stopSimulation",
            value: function() {
                ...
                void 0 !== this.viewFunction && (this.body.emitter.off("initRedraw", this.viewFunction), this.viewFunction = void 0, !0 === t && this.body.emitter.emit("_stopRendering"))
            }
        },
        {
            key: "simulationStep",
            value: function() {
                var t = tr();
                this.physicsTick(),
                (tr() - t < .4 * this.simulationInterval || !0 === this.runDoubleSpeed) && !1 === this.stabilized && (this.physicsTick(), this.runDoubleSpeed = !0),
        ...
        },
        {
            ...
            value: function() {
                var t = this,
                e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.stabilizationIterations; (this.stabilizationIterations > 1 || !0 === this.startedStabilization) && Td((function() {
        ...
        {
            key: "adjustTimeStep",
            value: function() { ! 0 === this._evaluateStepQuality() ? this.timestep = 1.2 * this.timestep: this.timestep / 1.2 < this.options.timestep ? this.timestep = this.options.timestep: (this.adaptiveCounter = -1, this.timestep = Math.max(this.options.timestep, this.timestep / 1.2))
            }
        },
        {
            key: "physicsTick",
            value: function() {
                if (this._startStabilizing(), !0 !== this.stabilized) {
                    if (!0 === this.adaptiveTimestep && !0 === this.adaptiveTimestepEnabled) this.adaptiveCounter % this.adaptiveInterval == 0 ? (this.timestep = 2 * this.timestep, this.physicsStep(), this.revert(), this.timestep = .5 * this.timestep, this.physicsStep(), this.physicsStep(), this.adjustTimeStep()) : this.physicsStep(),
                    this.adaptiveCounter += 1;
                    else this.timestep = this.options.timestep,
                    this.physicsStep(); ! 0 === this.stabilized && this.revert(),
        ...
        },
        {
            key: "moveNodes",
            value: function() {
                for (var t = this.physicsBody.physicsNodeIndices,
                e = 0,
                i = 0,
                o = 0; o < t.length; o++) {
                    var n = t[o],
        ...
        },
        {
            ...
            value: function(t) {
                ...
                !1 === e.options.fixed.x ? (o.x = this.calculateComponentVelocity(o.x, i.x, e.options.mass), e.x += o.x * this.timestep) : (i.x = 0, o.x = 0),
                !1 === e.options.fixed.y ? (o.y = this.calculateComponentVelocity(o.y, i.y, e.options.mass), e.y += o.y * this.timestep) : (i.y = 0, o.y = 0),
        ...
        },
        {
            ...
            value: function() {
                ...
                "number" != typeof e && (e = this.options.stabilization.iterations, console.error("The stabilize method needs a numeric amount of iterations. Switching to default: ", e)),
        ...
        },
        {
            ...
            value: function() {
                ...
                n++; (i(), e()) ? Td(Q(o = this._stabilizationBatch).call(o, this), 0) : this._finalizeStabilization()
            }
        },
        {
        ...
        },
        {
            ...
            value: function(t) {
                for (var e = 0; e < this.physicsBody.physicsNodeIndices.length; e++) {
                    ...
                    a = 3 * s,
                    h = Gr((180 - 180 * Math.min(1, Math.max(0, .03 * r))) / 360, 1, 1),
                    d = {
                        x: o.x + 20 * n.x,
                        y: o.y + 20 * n.y
                    };
    ...
    Ou = new Uint8Array(16);
    function Cu() {
        if (!_u && !(_u = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto) || "undefined" != typeof msCrypto && "function" == typeof msCrypto.getRandomValues && msCrypto.getRandomValues.bind(msCrypto))) throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");
        return _u(Ou)
    }
    var Su = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;
    function Tu(t) {
        return "string" == typeof t && Su.test(t)
    }
    for (var Mu = [], Du = 0; Du < 256; ++Du) Mu.push((Du + 256).toString(16).substr(1));
    function Pu(t, e, i) {
        var o = (t = t || {}).random || (t.rng || Cu)();
        ...
        return function(t) {
            ...
            i = (Mu[t[e + 0]] + Mu[t[e + 1]] + Mu[t[e + 2]] + Mu[t[e + 3]] + "-" + Mu[t[e + 4]] + Mu[t[e + 5]] + "-" + Mu[t[e + 6]] + Mu[t[e + 7]] + "-" + Mu[t[e + 8]] + Mu[t[e + 9]] + "-" + Mu[t[e + 10]] + Mu[t[e + 11]] + Mu[t[e + 12]] + Mu[t[e + 13]] + Mu[t[e + 14]] + Mu[t[e + 15]]).toLowerCase();
            if (!Tu(i)) throw TypeError("Stringified UUID is invalid");
            return i
        } (o)
    }
    var Iu = function() {
        ...
        },
        {
            ...
            value: function(t, e) {
                var i = {};
                return void 0 === e || "node" === e ? (Ar(i, t.options, !0), i.x = t.x, i.y = t.y, i.amountOfConnections = t.edges.length) : Ar(i, t.options, !0),
                i
            }
        }]),
        t
    ...
    var Bu = function(t) {
        ...
        function i(t, o, n, r, s, a) {
            var h;
            return ed(this, i),
            (h = e.call(this, t, o, n, r, s, a)).isCluster = !0,
            h.containedNodes = {},
            h.containedEdges = {},
            h
        }
        return od(i, [{
            ...
            value: function(t) {
                ...
                Hr(i.edges, (function(t) {
                    delete e.containedEdges[t.id]
                })),
                Hr(i.containedNodes, (function(t, i) {
                    e.containedNodes[i] = t
                })),
                i.containedNodes = {},
                Hr(i.containedEdges, (function(t, i) {
                    e.containedEdges[i] = t
                })),
                i.containedEdges = {},
                Hr(i.edges, (function(t) {
                    Hr(e.edges, (function(i) {
                        var o, n, r = On(o = i.clusteringEdgeReplacingIds).call(o, t.id); - 1 !== r && (Hr(t.clusteringEdgeReplacingIds, (function(t) {
                            i.clusteringEdgeReplacingIds.push(t),
                            e.body.edges[t].edgeReplacedById = i.id
                        })), ls(n = i.clusteringEdgeReplacingIds).call(n, r, 1))
                    }))
                })),
                i.edges = []
            }
    ...
    Fu = function() {
        ...
        return od(t, [{
            ...
            value: function(t, e) {
                void 0 === t ? t = this._getHubSize() : "object" === cr(t) && (e = this._checkOptions(t), t = this._getHubSize());
        ...
        },
        {
            ...
            value: function() {
                ...
                var o = {},
                n = {};
                Hr(this.body.nodes, (function(i, r) {
                    i.options && !0 === e.joinCondition(i.options) && (o[r] = i, Hr(i.edges, (function(e) {
            ...
            value: function(t, e) {
                ...
                d = function(o) {
                    ...
                    if (void 0 === h[c]) {
                        s = 0,
                        r = [];
                        for (var f = 0; f < u.edges.length; f++) n = u.edges[f],
                        void 0 === i.clusteredEdges[n.id] && (n.toId !== n.fromId && s++, r.push(n));
                        if (s === t) {
                            for (var p = function(t) {
                                if (void 0 === e.joinCondition || null === e.joinCondition) return ! 0;
                                var i = Iu.cloneOptions(t);
                            ...
                            if (ir(d).length > 0 && ir(l).length > 0 && !0 === v) {
                                var m = function() {
                ...
                for (var c = 0; c < a.length; c++) this._cluster(a[c].nodes, a[c].edges, e, !1); ! 0 === o && this.body.emitter.emit("_dataChanged")
            }
        },
        {
            key: "clusterOutliers",
                ...
                for (var d = 0; d < n.edges.length; d++) {
                    ...
                    if (void 0 === this.clusteredEdges[l.id]) {
                        ...
                        r[c] = this.body.nodes[c];
                            ...
                            var u = Iu.cloneOptions(this.body.nodes[c]); ! 0 === e.joinCondition(h, u) && (s[l.id] = l, r[c] = this.body.nodes[c])
                        } else s[l.id] = l
                    }
                }
                var f = hr(i = ir(r)).call(i, (function(t) {
                    return r[t].id
                }));
        ...
        },
        {
            ...
            value: function(t, e, i, o) {
                for (var n, r, s, a, h, d, l = ir(t), c = [], u = 0; u < l.length; u++) {
                    s = t[r = l[u]];
                    for (var f = 0; f < s.edges.length; f++) n = s.edges[f],
                    void 0 === this.clusteredEdges[n.id] && (n.toId == n.fromId ? e[n.id] = n: n.toId == r ? (a = i.id, d = h = n.fromId) : (a = n.toId, h = i.id, d = a), void 0 === t[d] && c.push({
                        edge: n,
                        fromId: h,
                        toId: a
                    }))
                ...
                g = 0; g < c.length; g++) {
                    ...
                    m = y.edge,
                    b = v(y);
                    null === b ? (b = this._createClusteredEdge(y.fromId, y.toId, m, o), p.push(b)) : b.clusteringEdgeReplacingIds.push(m.id),
        ...
        },
        {
            ...
            value: function(t, e, i) {
                ...
                if (0 != ir(t).length && (1 != ir(t).length || 1 == i.clusterNodeProperties.allowSingleNodeCluster)) {
                    var a = Ar({},
                    ...
                    if (void 0 !== i.processProperties) {
                        ...
                        for (var u in e) if (Object.prototype.hasOwnProperty.call(e, u) && "clusterEdge:" !== u.substr(0, 12)) {
                            var f = Iu.cloneOptions(e[u], "edge");
                            c.push(f)
                        }
                        if (! (a = i.processProperties(a, h, c))) throw new Error("The processProperties function does not return properties!")
                    }
                    void 0 === a.id && (a.id = "cluster:" + Pu());
                    var p = a.id;
                    void 0 === a.label && (a.label = "cluster");
                    var v = void 0;
                    void 0 === a.x && (v = this._getClusterPosition(t), a.x = v.x),
                    void 0 === a.y && (void 0 === v && (v = this._getClusterPosition(t)), a.y = v.y),
                    a.id = p;
                    var g = this.body.functions.createNode(a, Bu);
                    g.containedNodes = t,
                    g.containedEdges = e,
        ...
        },
        {
            ...
            value: function(t) {
                for (var e, i = ir(t), o = t[i[0]].x, n = t[i[0]].x, r = t[i[0]].y, s = t[i[0]].y, a = 1; a < i.length; a++) o = (e = t[i[a]]).x < o ? e.x: o,
                n = e.x > n ? e.x: n,
                r = e.y < r ? e.y: r,
                s = e.y > s ? e.y: s;
                return {
        ...
        },
        {
            ...
            value: function(t, e) {
                ...
                } else Hr(h, (function(t) { ! 1 === t.options.fixed.x && (t.x = o.x),
                    !1 === t.options.fixed.y && (t.y = o.y)
                }));
                ...
                for (var k = 0; k < b.length; k++) {
                    for (var _ = b[k], x = this._getConnectedId(_, t), E = this.clusteredNodes[x], O = 0; O < _.clusteringEdgeReplacingIds.length; O++) {
                        ...
                        if (void 0 !== S) if (void 0 !== E) {
                            ...
                            T.containedEdges[S.id] = S,
                            delete d[S.id];
                            var M = S.fromId,
                            D = S.toId;
                            S.toId == x ? D = E.clusterId: M = E.clusterId,
                            this._createClusteredEdge(M, D, S, T.clusterEdgeProperties, {
                                hidden: !1,
                                physics: !0
                            })
        ...
        },
        {
            ...
            value: function(t) {
                ...
                return void 0 === (e = this.body.nodes[t]) ? [] : (i.push(e.id), aa(i).call(i), i)
            }
        },
        {
                    ...
                    if (void 0 !== r) {
                        ...
                        if (void 0 !== s) {
                            ...
                            if (void 0 === a) o.push(r);
                                ...
                                var d = a[h]; - 1 === On(e).call(e, a) && -1 === On(i).call(i, a) && e.push(d)
                            }
                            i.push(r)
                        }
                    }
        ...
        },
        {
            ...
            value: function() {
                ...
                i = 0,
                o = 0,
                n = 0; n < this.body.nodeIndices.length; n++) {
        ...
        },
        {
            ...
            value: function() {
                ...
                o = {},
                n = function(t) {
                    Hr(e.body.nodes, (function(e) { ! 0 === e.isCluster && t(e)
                    }))
                };
                ...
                Hr(this.clusteredEdges, (function(t) {
                    var i = e.body.edges[t];
                    void 0 !== i && i.endPointsValid() || (o[t] = t)
                })),
                n((function(t) {
                    Hr(t.containedEdges, (function(t, e) {
                        t.endPointsValid() || o[e] || (o[e] = e)
                    }))
                })),
                Hr(this.body.edges, (function(t, i) {
                    var n = !0,
                ...
                Hr(ir(this.body.edges), (function(t) {
                    var i = e.body.edges[t],
                ...
                h = function() {
                    var t = [];
                    n((function(e) {
                        var i = ir(e.containedNodes).length,
                        o = !0 === e.options.allowSingleNodeCluster; (o && i < 1 || !o && i < 2) && t.push(e.id)
                    }));
                    for (var i = 0; i < t.length; ++i) e.openCluster(t[i], {},
                    !1);
                    a = t.length > 0,
                    s = s || a
                }; a;) h();
    ...
    function Nu(t, e) {
        ...
        if (void 0 === wr || null == ro(t)) {
            if (dr(t) || (i = function(t, e) {
                ...
                "Object" === o && t.constructor && (o = t.constructor.name);
                if ("Map" === o || "Set" === o) return mo(t);
                if ("Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return Au(t, e)
            } (t)) || e && t && "number" == typeof t.length) {
                i && (t = i);
                var o = 0,
                n = function() {};
    ...
    function Au(t, e) { (null == e || e > t.length) && (e = t.length);
        for (var i = 0,
        o = new Array(e); i < e; i++) o[i] = t[i];
        return o
    }
    var Ru = function() {
        function t(e, i) {
            var o;
            ed(this, t),
            void 0 !== window && (o = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame),
            window.requestAnimationFrame = void 0 === o ?
            function(t) {
                t()
            }: o,
            this.body = e,
            ...
            value: function() {
                ...
                this.body.emitter.on("zoom", (function() {
                    ...
                    e.zoomTimeoutId = window.setTimeout((function() {
                        var t;
                        e.zooming = !1,
                        Q(t = e._requestRedraw).call(t, e)()
                    }), 250)
                })),
                this.body.emitter.on("_resizeNodes", (function() {
                    e._resizeNodes()
                })),
                this.body.emitter.on("_redraw", (function() { ! 1 === e.renderingActive && e._redraw()
                })),
                ...
                this.body.emitter.on("_requestRedraw", Q(t = this._requestRedraw).call(t, this)),
        ...
        },
        {
            ...
            value: function(t) {
                if (void 0 !== t) {
                    Fr(["hideEdgesOnDrag", "hideEdgesOnZoom", "hideNodesOnDrag"], this.options, t)
                }
            }
        },
        {
        ...
        },
        {
            key: "_startRendering",
            value: function() {
                var t; ! 0 === this.renderingActive && (void 0 === this.renderTimer && (this.renderTimer = this._requestNextFrame(Q(t = this._renderStep).call(t, this), this.simulationInterval)))
            }
        },
        {
            key: "_renderStep",
            value: function() { ! 0 === this.renderingActive && (this.renderTimer = void 0, !0 === this.requiresTimeout && this._startRendering(), this._redraw(), !1 === this.requiresTimeout && this._startRendering())
            }
        },
        {
            key: "redraw",
        ...
        },
        {
            key: "_requestRedraw",
            value: function() {
                var t = this; ! 0 !== this.redrawRequested && !1 === this.renderingActive && !0 === this.allowRedraw && (this.redrawRequested = !0, this._requestNextFrame((function() {
                    t._redraw(!1)
                }), 0))
            }
        },
        ...
        },
        {
            ...
            value: function() {
                if ("undefined" != typeof window) {
                    ...
                    ( - 1 != On(t).call(t, "msie 9.0") || -1 != On(t).call(t, "safari") && On(t).call(t, "chrome") <= -1) && (this.requiresTimeout = !0)
    ...
    var Wu = function() {
        ...
        return od(t, [{
            ...
            value: function() {
                ...
                this.body.emitter.on("setSize", Q(t = this.setSize).call(t, this)),
                this.body.emitter.on("destroy", (function() {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                if (void 0 !== t) {
                    Fr(["width", "height", "autoResize"], this.options, t)
                }
                if (this._cleanUp(), !0 === this.options.autoResize) {
                    var a;
                    if (window.ResizeObserver) {
                        var h = new ResizeObserver((function() { ! 0 === s.setSize() && s.body.emitter.emit("_requestRedraw")
                        })),
                        d = this.frame;
                        h.observe(d),
                        ...
                        var l = ju((function() { ! 0 === s.setSize() && s.body.emitter.emit("_requestRedraw")
                        }), 1e3);
                        this._cleanupCallbacks.push((function() {
                            clearInterval(l)
                        }))
                    }
                    var c = Q(a = this._onResize).call(a, this);
                    e = window,
                    i = "resize",
                    o = c,
                    e.addEventListener ? (void 0 === n && (n = !1), "mousewheel" === i && On(r = navigator.userAgent).call(r, "Firefox") >= 0 && (i = "DOMMouseScroll"), e.addEventListener(i, o, n)) : e.attachEvent("on" + i, o),
                    this._cleanupCallbacks.push((function() { !
                        function(t, e, i, o) {
                            var n;
                            t.removeEventListener ? (void 0 === o && (o = !1), "mousewheel" === e && On(n = navigator.userAgent).call(n, "Firefox") >= 0 && (e = "DOMMouseScroll"), t.removeEventListener(e, i, o)) : t.detachEvent("on" + e, i)
                        } (window, "resize", c)
                    }))
                }
            }
        },
        {
            ...
            value: function() {
                var t, e, i;
                qo(t = aa(e = ls(i = this._cleanupCallbacks).call(i, 0)).call(e)).call(t, (function(t) {
                    try {
                        t()
                    } catch(t) {
                        console.error(t)
        ...
        },
        {
            key: "_getCameraState",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.pixelRatio; ! 0 === this.initialized && (this.cameraState.previousWidth = this.frame.canvas.width / t, this.cameraState.previousHeight = this.frame.canvas.height / t, this.cameraState.scale = this.body.view.scale, this.cameraState.position = this.DOMtoCanvas({
        ...
        },
        {
            ...
            value: function() {
                ...
                if (this.frame = document.createElement("div"), this.frame.className = "vis-network", this.frame.style.position = "relative", this.frame.style.overflow = "hidden", this.frame.tabIndex = 0, this.frame.canvas = document.createElement("canvas"), this.frame.canvas.style.position = "relative", this.frame.appendChild(this.frame.canvas), this.frame.canvas.getContext) this._setPixelRatio(),
                this.setTransform();
                else {
        ...
        },
        {
            ...
            value: function() {
                ...
                this.drag = {},
                this.pinch = {},
                this.hammer = new $h(this.frame.canvas),
                ...
                this.hammerFrame = new $h(this.frame),
                Hu(this.hammerFrame, (function(e) {
        ...
        },
        {
            ...
            value: function() {
                ...
                r = this.pixelRatio;
                if (this._setPixelRatio(), t != this.options.width || e != this.options.height || this.frame.style.width != t || this.frame.style.height != e) this._getCameraState(r),
                ...
                i = !0;
                    ...
                    this.frame.canvas.width !== s && (this.frame.canvas.width = s, i = !0),
                    this.frame.canvas.height !== a && (this.frame.canvas.height = a, i = !0)
                }
    ...
    function Vu(t, e) {
        ...
        null != t ? t: {});
        if (!dr(i.nodes)) throw new TypeError("Nodes has to be an array of ids.");
    ...
    var qu = function() {
        function t(e, i) {
            ...
            this.body.emitter.on("fit", Q(o = this.fit).call(o, this)),
            this.body.emitter.on("animationFinished", (function() {
                r.body.emitter.emit("_stopRendering")
            })),
            this.body.emitter.on("unlockNode", Q(n = this.releaseNode).call(n, this))
        }
        return od(t, [{
            key: "setOptions",
            value: function() {
        ...
        },
        {
            ...
            value: function(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                t = Vu(t, this.body.nodeIndices);
                var i, o, n = this.canvas.frame.canvas.clientWidth,
                r = this.canvas.frame.canvas.clientHeight;
                if (0 === n || 0 === r) o = 1,
                i = Iu.getRange(this.body.nodes, t.nodes);
                else if (!0 === e) {
                    var s = 0;
                    for (var a in this.body.nodes) if (Object.prototype.hasOwnProperty.call(this.body.nodes, a)) {
                        var h = this.body.nodes[a]; ! 0 === h.predefinedPosition && (s += 1)
                    }
        ...
        },
        {
            ...
            value: function(t) {
                if (void 0 !== t) {
                    if (null != t.offset) {
                        if (null != t.offset.x) {
                            if (t.offset.x = +t.offset.x, !Ad(t.offset.x)) throw new TypeError('The option "offset.x" has to be a finite number.')
                        } else t.offset.x = 0;
                        if (null != t.offset.y) {
                            if (t.offset.y = +t.offset.y, !Ad(t.offset.y)) throw new TypeError('The option "offset.y" has to be a finite number.')
                        } else t.offset.x = 0
                    } else t.offset = {
                        x: 0,
                        y: 0
                    ...
                    if (null != t.position) {
                        if (null != t.position.x) {
                            if (t.position.x = +t.position.x, !Ad(t.position.x)) throw new TypeError('The option "position.x" has to be a finite number.')
                        } else t.position.x = 0;
                        if (null != t.position.y) {
                            if (t.position.y = +t.position.y, !Ad(t.position.y)) throw new TypeError('The option "position.y" has to be a finite number.')
                        } else t.position.x = 0
        ...
        },
        {
            ...
            value: function(t) {
                if (void 0 !== t) {
                    ...
                    this.releaseNode(),
                    !0 === t.locked && (this.lockedOnNodeId = t.lockedOnNode, this.lockedOnNodeOffset = t.offset),
                    ...
                    0 === t.animation.duration) if (null != this.lockedOnNodeId) this.viewFunction = Q(e = this._lockedRedraw).call(e, this),
                    this.body.emitter.on("initRedraw", this.viewFunction);
                    else this.body.view.scale = this.targetScale,
                    this.body.view.translation = this.targetTranslation,
                    this.body.emitter.emit("_requestRedraw");
                    else this.animationSpeed = 1 / (60 * t.animation.duration * .001) || 1 / 60,
                    this.animationEasingFunction = t.animation.easingFunction,
                    this.viewFunction = Q(i = this._transitionRedraw).call(i, this),
                    this.body.emitter.on("initRedraw", this.viewFunction),
        ...
        },
        {
            ...
            value: function() {
                ...
                var e = ts[this.animationEasingFunction](this.easingTime);
                ...
                this.easingTime >= 1) {
                    var i;
                    if (this.body.emitter.off("initRedraw", this.viewFunction), this.easingTime = 0, null != this.lockedOnNodeId) this.viewFunction = Q(i = this._lockedRedraw).call(i, this),
                    this.body.emitter.on("initRedraw", this.viewFunction);
    ...
    var Yu = function() {
        ...
        {
            key: "create",
            value: function() { ! 0 === this.options.navigationButtons ? !1 === this.iconsCreated && this.loadNavigationElements() : !0 === this.iconsCreated && this.cleanNavigation(),
        ...
        },
        {
            ...
            value: function() {
                ...
                for (var o = 0; o < e.length; o++) {
                    ...
                    var n, r, s = new $h(this.navigationDOM[e[o]]);
                    if ("_fit" === i[o]) Lu(s, Q(n = this._fit).call(n, this));
                    else Lu(s, Q(r = this.bindToRedraw).call(r, this, i[o]));
                    this.navigationHammers.push(s)
                }
                var a = new $h(this.canvas.frame);
                Hu(a, (function() {
                    t._stopMovement()
                })),
        ...
        },
        {
            ...
            value: function(t) {
                var e;
                void 0 === this.boundFunctions[t] && (this.boundFunctions[t] = Q(e = this[t]).call(e, this), this.body.emitter.on("initRedraw", this.boundFunctions[t]), this.body.emitter.emit("_startRendering"))
            }
        },
        {
        ...
        {
            key: "_fit",
            value: function() { (new Date).valueOf() - this.touchTime > 700 && (this.body.emitter.emit("fit", {
                    duration: 700
        ...
        },
        {
            ...
            value: function() {
                var t, e, i, o, n, r, s, a, h, d, l, c, u, f, p, v, g, y, m, b, w, k, _, x, E = this; (void 0 !== this.keycharm && this.keycharm.destroy(), !0 === this.options.keyboard.enabled) && (!0 === this.options.keyboard.bindToWindow ? this.keycharm = Uu({
                    container: window,
                    preventDefault: !0
                }) : this.keycharm = Uu({
                    container: this.canvas.frame,
                    preventDefault: !0
                }), this.keycharm.reset(), !0 === this.activated && (Q(t = this.keycharm).call(t, "up", (function() {
                    E.bindToRedraw("_moveUp")
                }), "keydown"), Q(e = this.keycharm).call(e, "down", (function() {
                    E.bindToRedraw("_moveDown")
                }), "keydown"), Q(i = this.keycharm).call(i, "left", (function() {
                    E.bindToRedraw("_moveLeft")
                }), "keydown"), Q(o = this.keycharm).call(o, "right", (function() {
                    E.bindToRedraw("_moveRight")
                }), "keydown"), Q(n = this.keycharm).call(n, "=", (function() {
                    E.bindToRedraw("_zoomIn")
                }), "keydown"), Q(r = this.keycharm).call(r, "num+", (function() {
                    E.bindToRedraw("_zoomIn")
                }), "keydown"), Q(s = this.keycharm).call(s, "num-", (function() {
                    E.bindToRedraw("_zoomOut")
                }), "keydown"), Q(a = this.keycharm).call(a, "-", (function() {
                    E.bindToRedraw("_zoomOut")
                }), "keydown"), Q(h = this.keycharm).call(h, "[", (function() {
                    E.bindToRedraw("_zoomOut")
                }), "keydown"), Q(d = this.keycharm).call(d, "]", (function() {
                    E.bindToRedraw("_zoomIn")
                }), "keydown"), Q(l = this.keycharm).call(l, "pageup", (function() {
                    E.bindToRedraw("_zoomIn")
                }), "keydown"), Q(c = this.keycharm).call(c, "pagedown", (function() {
                    E.bindToRedraw("_zoomOut")
                }), "keydown"), Q(u = this.keycharm).call(u, "up", (function() {
                    E.unbindFromRedraw("_moveUp")
                }), "keyup"), Q(f = this.keycharm).call(f, "down", (function() {
                    E.unbindFromRedraw("_moveDown")
                }), "keyup"), Q(p = this.keycharm).call(p, "left", (function() {
                    E.unbindFromRedraw("_moveLeft")
                }), "keyup"), Q(v = this.keycharm).call(v, "right", (function() {
                    E.unbindFromRedraw("_moveRight")
                }), "keyup"), Q(g = this.keycharm).call(g, "=", (function() {
                    E.unbindFromRedraw("_zoomIn")
                }), "keyup"), Q(y = this.keycharm).call(y, "num+", (function() {
                    E.unbindFromRedraw("_zoomIn")
                }), "keyup"), Q(m = this.keycharm).call(m, "num-", (function() {
                    E.unbindFromRedraw("_zoomOut")
                }), "keyup"), Q(b = this.keycharm).call(b, "-", (function() {
                    E.unbindFromRedraw("_zoomOut")
                }), "keyup"), Q(w = this.keycharm).call(w, "[", (function() {
                    E.unbindFromRedraw("_zoomOut")
                }), "keyup"), Q(k = this.keycharm).call(k, "]", (function() {
                    E.unbindFromRedraw("_zoomIn")
                }), "keyup"), Q(_ = this.keycharm).call(_, "pageup", (function() {
                    E.unbindFromRedraw("_zoomIn")
                }), "keyup"), Q(x = this.keycharm).call(x, "pagedown", (function() {
                    E.unbindFromRedraw("_zoomOut")
                }), "keyup")))
            }
        }]),
    ...
    function Gu(t, e) {
        ...
        if (void 0 === wr || null == ro(t)) {
            if (dr(t) || (i = function(t, e) {
                ...
                "Object" === o && t.constructor && (o = t.constructor.name);
                if ("Map" === o || "Set" === o) return mo(t);
                if ("Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return Ku(t, e)
            } (t)) || e && t && "number" == typeof t.length) {
                i && (t = i);
                var o = 0,
                n = function() {};
    ...
    function Ku(t, e) { (null == e || e > t.length) && (e = t.length);
        for (var i = 0,
        o = new Array(e); i < e; i++) o[i] = t[i];
        return o
    }
    var $u = function() {
        function t(e, i, o) {
            ...
            this.navigationHandler = new Yu(e, i),
            this.body.eventListeners.onTap = Q(n = this.onTap).call(n, this),
            this.body.eventListeners.onTouch = Q(r = this.onTouch).call(r, this),
            this.body.eventListeners.onDoubleTap = Q(s = this.onDoubleTap).call(s, this),
            this.body.eventListeners.onHold = Q(a = this.onHold).call(a, this),
            this.body.eventListeners.onDragStart = Q(h = this.onDragStart).call(h, this),
            this.body.eventListeners.onDrag = Q(d = this.onDrag).call(d, this),
            this.body.eventListeners.onDragEnd = Q(l = this.onDragEnd).call(l, this),
            this.body.eventListeners.onMouseWheel = Q(c = this.onMouseWheel).call(c, this),
            this.body.eventListeners.onPinch = Q(u = this.onPinch).call(u, this),
            this.body.eventListeners.onMouseMove = Q(f = this.onMouseMove).call(f, this),
            this.body.eventListeners.onRelease = Q(p = this.onRelease).call(p, this),
            this.body.eventListeners.onContext = Q(v = this.onContext).call(v, this),
            this.touchTime = 0,
            this.drag = {},
            this.pinch = {},
            this.popup = void 0,
            ...
            this.body.functions.getPointer = Q(g = this.getPointer).call(g, this),
            this.options = {},
            this.defaultOptions = {
                dragNodes: !0,
                dragView: !0,
        ...
        },
        {
            ...
            value: function(t) {
                if (void 0 !== t) {
                    Nr(["hideEdgesOnDrag", "hideEdgesOnZoom", "hideNodesOnDrag", "keyboard", "multiselect", "selectable", "selectConnectedEdges"], this.options, t),
                    Jr(this.options, t, "keyboard"),
                    t.tooltip && (bt(this.options.tooltip, t.tooltip), t.tooltip.color && (this.options.tooltip.color = Ur(t.tooltip.color)))
                }
        ...
        },
        {
            ...
            value: function(t) {
                return {
                    ...
                    y: t.y - Lr(this.canvas.frame.canvas)
                };
                var e
            }
        }, {
            key: "onTouch",
            value: function(t) { (new Date).valueOf() - this.touchTime > 50 && (this.drag.pointer = this.getPointer(t.center), this.drag.pinched = !1, this.pinch.scale = this.body.view.scale, this.touchTime = (new Date).valueOf())
            }
        },
        {
            key: "onTap",
        ...
        },
        {
            ...
            value: function(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]; ! 0 === e ? this.selectionHandler.selectAdditionalOnPoint(t) : this.selectionHandler.selectOnPoint(t)
            }
        },
        {
            ...
            value: function(t, e) {
                var i = function(t, e) {
                    for (var i = [], o = 0; o < t.length; o++) {
                        var n = t[o]; - 1 === On(e).call(e, n) && i.push(n)
                    }
                    return i
                };
                return {
        ...
        },
        {
            ...
            value: function(t) {
                if (!this.drag.dragging) {
                    ...
                    if (this.drag.dragging = !0, this.drag.selection = [], this.drag.translation = bt({},
                    ...
                    if (void 0 !== e && !0 === this.options.dragNodes) {
                        ...
                        !1 === e.isSelected() && (this.selectionHandler.unselectAll(), this.selectionHandler.selectObject(e)),
                        this.selectionHandler.generateClickEvent("dragStart", t, this.drag.pointer);
                        var o, n = Gu(this.selectionHandler.getSelectedNodes());
                        try {
                            for (n.s(); ! (o = n.n()).done;) {
                                var r = o.value,
                                s = {
            ...
            value: function(t) {
                ...
                if (!0 !== this.drag.pinched) {
                    ...
                    if (o && o.length && !0 === this.options.dragNodes) {
                        ...
                        qo(o).call(o, (function(t) {
                            var i = t.node; ! 1 === t.xFixed && (i.x = e.canvas._XconvertDOMtoCanvas(e.canvas._XconvertCanvasToDOM(t.x) + n)),
        ...
        },
        {
            ...
            value: function(t) {
                ...
                if (this.drag.dragging = !1, this.body.selectionBox.show) {
                    ...
                    a && a.length ? (qo(a).call(a, (function(t) {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                o = !1;
                void 0 !== this.popup && (!1 === this.popup.hidden && this._checkHidePopup(i), !1 === this.popup.hidden && (o = !0, this.popup.setPosition(i.x + 3, i.y - 5), this.popup.show())),
                !1 === this.options.keyboard.bindToWindow && !0 === this.options.keyboard.enabled && this.canvas.frame.focus(),
                !1 === o && (void 0 !== this.popupTimer && (clearInterval(this.popupTimer), this.popupTimer = void 0), this.drag.dragging || (this.popupTimer = Td((function() {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                } else void 0 === this.selectionHandler.getNodeAt(t) && void 0 !== this.body.edges[this.popup.popupTargetId] && (i = this.body.edges[this.popup.popupTargetId].isOverlappingWith(e)); ! 1 === i && (this.popupObj = void 0, this.popup.hide(), this.body.emitter.emit("hidePopup"))
            }
        }]),
        t
    } (),
    ...
    of = 0,
    nf = function(t) {
        return t.frozen || (t.frozen = new rf)
    },
    rf = function() {
        this.entries = []
    },
    sf = function(t, e) {
        return tf(t.entries, (function(t) {
            return t[0] === e
        }))
    };
    rf.prototype = {
        ...
        delete: function(t) {
            var e = ef(this.entries, (function(e) {
                return e[0] === t
            }));
    ...
    var af, hf, df, lf, cf, uf = {
        getConstructor: function(t, e, i, o) {
            ...
            s = function(t, e, i) {
                var o = r(t),
                n = Zu(R(e), !0);
                return ! 0 === n ? nf(o).set(e, i) : n[o.id] = i,
                t
            };
            return gd(n.prototype, {
                delete: function(t) {
                    ...
                    if (!m(t)) return ! 1;
                    var i = Zu(t);
                    return ! 0 === i ? nf(e).delete(t) : i && k(i, e.id) && delete i[e.id]
                },
                has: function(t) {
                    var e = r(this);
                    if (!m(t)) return ! 1;
                    var i = Zu(t);
                    return ! 0 === i ? nf(e).has(t) : i && k(i, e.id)
                }
            }),
            gd(n.prototype, i ? {
                get: function(t) {
                    ...
                    if (m(t)) {
                        var i = Zu(t);
                        return ! 0 === i ? nf(e).get(t) : i ? i[e.id] : void 0
                    }
                },
                set: function(t, e) {
                    return s(this, t, e)
    ...
    ff = (o((function(t) {
        var e, i = Le.enforce,
        o = !r.ActiveXObject && "ActiveXObject" in r,
        n = Object.isExtensible,
        s = function(t) {
            return function() {
                return t(this, arguments.length ? arguments[0] : void 0)
        ...
        a = t.exports = vd("WeakMap", s, uf);
        if (ze && o) {
            e = uf.getConstructor(s, "WeakMap", !0),
            ad.REQUIRED = !0;
            var h = a.prototype,
            d = h.delete,
            l = h.has,
            ...
            gd(h, {
                delete: function(t) {
                    if (m(t) && !n(t)) {
                        var o = i(this);
                        return o.frozen || (o.frozen = new e),
                        d.call(this, t) || o.frozen.delete(t)
                    }
                ...
                get: function(t) {
                    if (m(t) && !n(t)) {
                        var o = i(this);
                        return o.frozen || (o.frozen = new e),
                        l.call(this, t) ? c.call(this, t) : o.frozen.get(t)
                    }
                ...
                set: function(t, o) {
                    if (m(t) && !n(t)) {
                        ...
                        l.call(this, t) ? u.call(this, t, o) : r.frozen.set(t, o)
                    } else u.call(this, t, o);
                    return this
                }
            })
        }
    })), F.WeakMap),
    pf = (vd("Set", (function(t) {
        return function() {
            return t(this, arguments.length ? arguments[0] : void 0)
        }
    }), _d), F.Set);
	...
	***************************************************************************** */
    ...
    function yf(t, e) {
        ...
        if (void 0 === wr || null == ro(t)) {
            if (dr(t) || (i = function(t, e) {
                ...
                "Object" === o && t.constructor && (o = t.constructor.name);
                if ("Map" === o || "Set" === o) return mo(t);
                if ("Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return mf(t, e)
            } (t)) || e && t && "number" == typeof t.length) {
                i && (t = i);
                var o = 0,
                n = function() {};
    ...
    function mf(t, e) { (null == e || e > t.length) && (e = t.length);
        for (var i = 0,
        o = new Array(e); i < e; i++) o[i] = t[i];
        return o
    }
    ...
    var wf = function() {
        ...
        },
        {
            ...
            value: function() {
                return {
                    added: gr(bf(vf(this, af), vf(this, hf))),
                    deleted: gr(bf(vf(this, hf), vf(this, af))),
                    previous: gr(new pf(vf(this, af))),
                    current: gr(new pf(vf(this, hf)))
                }
            }
        },
        {
            ...
            value: function() {
                ...
                gf(this, af, vf(this, hf)),
                gf(this, hf, new pf(vf(this, af)));
                var e, i = yf(t.added);
                try {
                    for (i.s(); ! (e = i.n()).done;) {
                        e.value.select()
    ...
    var kf = function() {
        ...
        return od(t, [{
            key: "getNodes",
            value: function() {
                return vf(this, df).getSelection()
            }
        },
        {
            key: "getEdges",
            value: function() {
                return vf(this, lf).getSelection()
            }
        },
        {
            key: "addNodes",
            value: function() {
                var t; (t = vf(this, df)).add.apply(t, arguments)
            }
        },
        {
            key: "addEdges",
            value: function() {
                var t; (t = vf(this, lf)).add.apply(t, arguments)
            }
        },
        {
            key: "deleteNodes",
        ...
        },
        {
            ...
            value: function() {
                for (var t, e, i = {
                    nodes: vf(this, df).commit(),
                    edges: vf(this, lf).commit()
                },
                o = arguments.length, n = new Array(o), r = 0; r < o; r++) n[r] = arguments[r];
                return (t = vf(this, cf)).call.apply(t, br(e = [this, i]).call(e, n)),
                i
            }
        },
        {
            key: "sizeNodes",
            get: function() {
                return vf(this, df).size
            }
        },
        {
            key: "sizeEdges",
            get: function() {
                return vf(this, lf).size
            }
        }]),
        t
    } ();
    function _f(t, e) {
        ...
        if (void 0 === wr || null == ro(t)) {
            if (dr(t) || (i = function(t, e) {
                var i;
                if (!t) return;
                if ("string" == typeof t) return xf(t, e);
                var o = ur(i = Object.prototype.toString.call(t)).call(i, 8, -1);
                "Object" === o && t.constructor && (o = t.constructor.name);
                if ("Map" === o || "Set" === o) return mo(t);
                if ("Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return xf(t, e)
            } (t)) || e && t && "number" == typeof t.length) {
                i && (t = i);
                var o = 0,
                n = function() {};
    ...
    function xf(t, e) { (null == e || e > t.length) && (e = t.length);
        for (var i = 0,
        o = new Array(e); i < e; i++) o[i] = t[i];
        return o
    }
    ...
    var Ef = function() {
        function t(e, i) {
            ...
            this.body = e,
            this.canvas = i,
            this._selectionAccumulator = new kf,
            this.hoverObj = {
                nodes: {},
                edges: {}
            },
        ...
        return od(t, [{
            ...
            value: function(t) {
                if (void 0 !== t) {
                    Fr(["multiselect", "hoverConnectedEdges", "selectable", "selectConnectedEdges"], this.options, t)
                }
            }
        },
        {
        ...
        },
        {
            ...
            value: function(t, e, i, o) {
                ...
                void 0 !== o && (r.previousSelection = o),
        ...
        },
        {
            ...
            value: function(t) {
                ...
                if (void 0 !== t) {
                    if (t instanceof kc) {
                        var i;
                        if (!0 === e)(i = this._selectionAccumulator).addEdges.apply(i, gr(t.edges));
        ...
        {
            key: "deselectObject",
            value: function(t) { ! 0 === t.isSelected() && (t.selected = !1, this._removeFromSelection(t))
            }
        },
        {
        ...
        },
        {
            ...
            value: function(t, e) {
                for (var i = this.body.edges,
                o = 0; o < this.body.edgeIndices.length; o++) {
        ...
        },
        {
            key: "_addToHover",
            value: function(t) {
                t instanceof kc ? this.hoverObj.nodes[t.id] = t: this.hoverObj.edges[t.id] = t
            }
        },
        {
            ...
            value: function(t) {
                var e;
                t instanceof kc ? (this._selectionAccumulator.deleteNodes(t), (e = this._selectionAccumulator).deleteEdges.apply(e, gr(t.edges))) : this._selectionAccumulator.deleteEdges(t)
            }
        },
        {
            key: "unselectAll",
        ...
        },
        {
            key: "emitBlurEvent",
            value: function(t, e, i) {
                var o = this._initBaseEvent(t, e); ! 0 === i.hover && (i.hover = !1, i instanceof kc ? (o.node = i.id, this.body.emitter.emit("blurNode", o)) : (o.edge = i.id, this.body.emitter.emit("blurEdge", o)))
            }
        },
        {
            key: "emitHoverEvent",
            value: function(t, e, i) {
                ...
                n = !1;
                return ! 1 === i.hover && (i.hover = !0, this._addToHover(i), n = !0, i instanceof kc ? (o.node = i.id, this.body.emitter.emit("hoverNode", o)) : (o.edge = i.id, this.body.emitter.emit("hoverEdge", o))),
                n
            }
        },
        {
            ...
            value: function(t, e) {
                ...
                var o = !1;
                for (var n in this.hoverObj.nodes) Object.prototype.hasOwnProperty.call(this.hoverObj.nodes, n) && (void 0 === i || i instanceof kc && i.id != n || i instanceof cu) && (this.emitBlurEvent(t, e, this.hoverObj.nodes[n]), delete this.hoverObj.nodes[n], o = !0);
                for (var r in this.hoverObj.edges) Object.prototype.hasOwnProperty.call(this.hoverObj.edges, r) && (!0 === o ? (this.hoverObj.edges[r].hover = !1, delete this.hoverObj.edges[r]) : (void 0 === i || i instanceof cu && i.id != r || i instanceof kc && !i.hover) && (this.emitBlurEvent(t, e, this.hoverObj.edges[r]), delete this.hoverObj.edges[r], o = !0));
                if (void 0 !== i) {
                    var s = ir(this.hoverObj.edges).length,
                    a = ir(this.hoverObj.nodes).length; (o || i instanceof cu && 0 === s && 0 === a || i instanceof kc && 0 === s && 0 === a) && (o = this.emitHoverEvent(t, e, i)),
                    i instanceof kc && !0 === this.options.hoverConnectedEdges && this._hoverConnectedEdges(i)
        ...
        },
        {
            ...
            value: function(t, e) {
                ...
                o.edges.deleted.length > 0 && (this.generateClickEvent("deselectEdge", e, t, n), i = !0),
                o.nodes.deleted.length > 0 && (this.generateClickEvent("deselectNode", e, t, n), i = !0),
                o.nodes.added.length > 0 && (this.generateClickEvent("selectNode", e, t), i = !0),
                o.edges.added.length > 0 && (this.generateClickEvent("selectEdge", e, t), i = !0),
        ...
        },
        {
            ...
            value: function() {
                var t;
                return hr(t = this._selectionAccumulator.getNodes()).call(t, (function(t) {
                    return t.id
                }))
            }
        },
        {
            ...
            value: function() {
                var t;
                return hr(t = this._selectionAccumulator.getEdges()).call(t, (function(t) {
                    return t.id
                }))
            }
        },
        ...
        },
        {
            ...
            value: function(t) {
                ...
                for (var a = this.body.edgeIndices,
                h = this.body.edges,
                d = a.length - 1; d >= 0; d--) {
    ...
    var Pf = K("Array").reduce,
    If = Array.prototype,
    zf = function(t) {
        var e = t.reduce;
        return t === If || t instanceof Array && e === If.reduce ? Pf: e
    },
    Bf = [],
    Ff = Bf.sort,
    Nf = s((function() {
    ...
    {
        sort: function(t) {
            return void 0 === t ? Ff.call(vt(this)) : Ff.call(vt(this), N(t))
        }
    });
    var jf = K("Array").sort,
    Lf = Array.prototype,
    Hf = function(t) {
        var e = t.sort;
        return t === Lf || t instanceof Array && e === Lf.sort ? jf: e
    },
    Wf = o((function(t, e) { !
        function(t) {
            function e(t, e) {
            ...
            function a(t, e) {
                ...
                if (~~t === t && ~~e === e) {
                    ...
                    o = s(e),
                    n = 0;
                    return i < o ? (t *= r[o - i - 1], e /= 10, n = -1) : i > o && (e *= r[i - o - 1], t /= 10, n = 1),
                    t === e ? n: t < e ? -1 : 1
                }
                var a = String(t),
                h = String(e);
            ...
            function u(t, e, i, o, n, r) {
                ...
                h = 1;
                if (r(t, e[i + n]) > 0) {
                    for (a = o - n; h < a && r(t, e[i + n + h]) > 0;) s = h,
                    (h = 1 + (h << 1)) <= 0 && (h = a);
                    h > a && (h = a),
                    s += n,
                    h += n
                } else {
                    for (a = n + 1; h < a && r(t, e[i + n - h]) <= 0;) s = h,
                    (h = 1 + (h << 1)) <= 0 && (h = a);
                    h > a && (h = a);
                    var d = s;
                    s = n - h,
            ...
            var p = function() {
                function t(i, r) {
                    ...
                    this.length < 2 * n && (this.tmpStorageLength = this.length >>> 1),
                ...
                t.prototype.mergeAt = function(t) {
                    ...
                    t === this.stackSize - 3 && (this.runStart[t + 1] = this.runStart[t + 2], this.runLength[t + 1] = this.runLength[t + 2]),
                    this.stackSize--;
                    var a = f(i[r], i, o, n, 0, e);
                    o += a,
                    0 != (n -= a) && 0 !== (s = u(i[o + n - 1], i, r, s, s - 1, e)) && (n <= s ? this.mergeLow(o, n, r, s) : this.mergeHigh(o, n, r, s))
                },
            ...
            function v(t, e, o, n) {
                ...
                e ? "function" != typeof e && (n = o, o = e, e = a) : e = a,
                o || (o = 0),
                n || (n = t.length);
                var r = n - o;
                if (! (r < 2)) {
    ...
    {
        every: function(t) {
            return Xf(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var $f = K("Array").every,
    Zf = Array.prototype,
    Qf = function(t) {
        var e = t.every;
        return t === Zf || t instanceof Array && e === Zf.every ? $f: e
    };
    function Jf(t, e) {
        var i;
        if (void 0 === wr || null == ro(t)) {
            if (dr(t) || (i = function(t, e) {
                ...
                "Object" === o && t.constructor && (o = t.constructor.name);
                if ("Map" === o || "Set" === o) return mo(t);
                if ("Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return tp(t, e)
            } (t)) || e && t && "number" == typeof t.length) {
                i && (t = i);
                var o = 0,
                n = function() {};
    ...
    function tp(t, e) { (null == e || e > t.length) && (e = t.length);
        for (var i = 0,
        o = new Array(e); i < e; i++) o[i] = t[i];
        return o
    }
    function ep(t, e) {
        var i = new pf;
        return qo(t).call(t, (function(t) {
            var e;
            qo(e = t.edges).call(e, (function(t) {
                t.connected && i.add(t)
            }))
        })),
        qo(i).call(i, (function(t) {
            var i = t.from.id,
            o = t.to.id;
            null == e[i] && (e[i] = 0),
            (null == e[o] || e[i] >= e[o]) && (e[o] = e[i] + 1)
        })),
        e
    }
    function ip(t, e, i, o) {
        var n, r, s = ko(null),
        a = zf(n = gr(tl(o).call(o))).call(n, (function(t, e) {
        ...
        try {
            var c = function() {
                ...
                for (var u = [c], f = 0, p = void 0, v = function() {
                    ...
                    var r = s[p.id] + d;
                    if (qo(t = pn(n = p.edges).call(n, (function(t) {
                        return t.connected && t.to !== t.from && t[i] !== p && o.has(t.toId) && o.has(t.fromId)
                    }))).call(t, (function(t) {
                        var o = t[h],
                        n = s[o]; (null == n || e(r, n)) && (s[o] = r, u.push(t[i]))
                    })), f > a) return {
                        v: {
                            v: ep(o, s)
                        }
                    ...
                    var g = v();
                    if ("continue" !== g && "object" === cr(g)) return g.v
                }
            };
            for (l.s(); ! (r = l.n()).done;) {
                var u = c();
                if ("continue" !== u && "object" === cr(u)) return u.v
            }
        } catch(t) {
            l.e(t)
        } finally {
    ...
    var op = function() {
        ...
        },
        {
            key: "getLevels",
            value: function() {
                return ir(this.distributionOrdering)
            }
        },
        {
            key: "addToOrdering",
    ...
    np = function() {
        ...
        },
        {
            ...
            value: function(t, e) {
                if (void 0 !== t) {
                    ...
                    o = i.enabled;
                    if (Fr(["randomSeed", "improvedLayout", "clusterThreshold"], this.options, t), Jr(this.options, t, "hierarchical"), void 0 !== t.randomSeed && this._resetRNG(t.randomSeed), !0 === i.enabled) return ! 0 === o && this.body.emitter.emit("refresh", !0),
        ...
        },
        {
            ...
            value: function(t) {
                ...
                this._rng = xr(this.initialRandomSeed)
            }
        },
        {
            ...
            value: function(t) {
                if (!0 === this.options.hierarchical.enabled) {
                    ...
                    e.enabled = void 0 === e.enabled || e.enabled, e.solver = e.solver || "barnesHut") : "object" === cr(t.physics) ? (e.enabled = void 0 === t.physics.enabled || t.physics.enabled, e.solver = t.physics.solver || "barnesHut", t.physics.solver = "hierarchicalRepulsion") : !1 !== t.physics && (e.solver = "barnesHut", t.physics = {
                        solver: "hierarchicalRepulsion"
                    });
                    ...
                    t.edges.smooth = {
                        ...
                        void 0 !== o.type && "dynamic" !== o.type && (i = o.type),
        ...
        },
        {
            ...
            value: function(t) {
                if (!0 !== this.options.hierarchical.enabled) {
                    ...
                    for (var e = t.length + 50,
                    i = 0; i < t.length; i++) {
                        var o = t[i],
                        n = 2 * Math.PI * this._rng();
                        void 0 === o.x && (o.x = e * Math.cos(n)),
                        void 0 === o.y && (o.y = e * Math.sin(n))
                    }
                }
            }
        },
        {
            ...
            value: function() {
                if (!0 !== this.options.hierarchical.enabled && !0 === this.options.improvedLayout) {
                    for (var t = this.body.nodeIndices,
                    e = 0,
                    i = 0; i < t.length; i++) { ! 0 === this.body.nodes[t[i]].predefinedPosition && (e += 1)
                    }
                    if (e < .5 * t.length) {
                        var o = 0,
                        ...
                        if (t.length > n) {
                            for (var s = t.length; t.length > n && o <= 10;) {
                                o += 1;
                                var a = t.length;
                                if (o % 3 == 0 ? this.body.modules.clustering.clusterBridges(r) : this.body.modules.clustering.clusterOutliers(r), a == t.length && o % 3 != 0) return this._declusterAll(),
                        ...
                        for (var h = 0; h < t.length; h++) {
                            var d = this.body.nodes[t[h]]; ! 1 === d.predefinedPosition && (d.x += 70 * (.5 - this._rng()), d.y += 70 * (.5 - this._rng()))
                        }
                        this._declusterAll(),
        ...
        },
        {
            key: "_shiftToCenter",
            value: function() {
                for (var t = Iu.getRangeCore(this.body.nodes, this.body.nodeIndices), e = Iu.findCenter(t), i = 0; i < this.body.nodeIndices.length; i++) {
        ...
        },
        {
            ...
            value: function() {
                for (var t = !0; ! 0 === t;) {
                    ...
                    !1)); ! 0 === t && this.body.emitter.emit("_dataChanged")
                }
            }
        },
        {
        ...
        },
        {
            ...
            value: function() {
                if (!0 === this.options.hierarchical.enabled && this.body.nodeIndices.length > 0) {
                    ...
                    this.hierarchical = new op, this.body.nodes) Object.prototype.hasOwnProperty.call(this.body.nodes, e) && (void 0 !== (t = this.body.nodes[e]).options.level ? (i = !0, this.hierarchical.levels[e] = t.options.level) : o = !0);
            ...
            value: function() {
                ...
                s = function(e) {
                    ...
                    for (var a in e) if (Object.prototype.hasOwnProperty.call(e, a)) {
                        ...
                        o = Math.min(f, o),
                        n = Math.min(p, n),
                        d <= i && (r = Math.min(l, r), s = Math.max(l, s))
                    }
                    return [r, s, o, n]
                },
                a = function(e, i) {
                ...
                d = function(i, o) {
                    ...
                    if (l > c) {
                        ...
                        if (w > c) {
                            var k = y - m + c;
                            k < -b + c && (k = -b + c),
                            k < 0 && (t._shiftBlock(o.id, k), e = !0, !0 === n && t._centerParent(o))
                        }
                    }
                },
                l = function(o, n) {
                    for (var a = n.id,
                    h = n.edges,
                    d = t.hierarchical.levels[n.id], l = t.options.hierarchical.levelSeparation * t.options.hierarchical.levelSeparation, c = {},
                    u = [], f = 0; f < h.length; f++) {
                        var p = h[f];
                        if (p.toId != p.fromId) {
                            var v = p.toId == a ? p.from: p.to;
                            c[h[f].id] = v,
                            t.hierarchical.levels[v.id] < d && u.push(p)
                        }
                    }
                    var g = function(e, i) {
                        for (var o = 0,
                        n = 0; n < i.length; n++) if (void 0 !== c[i[n].id]) {
                    ...
                    m = function(e, i) {
                        for (var o = t.direction.getPosition(n), r = {},
                        s = 0; s < e; s++) {
                            var a = g(o, i),
                            h = y(o, i);
            ...
            value: function(t) {
                if (this.hierarchical.parentReference[t.id]) for (var e = this.hierarchical.parentReference[t.id], i = 0; i < e.length; i++) {
                    ...
                    if (void 0 !== r) {
                        ...
                        h = this._getSpaceAroundNode(n),
                        d = Jn(h, 2),
                        l = d[0],
                        c = d[1],
                        u = a - s; (u < 0 && Math.abs(u) < c - this.options.hierarchical.nodeSpacing || u > 0 && Math.abs(u) < l - this.options.hierarchical.nodeSpacing) && this.direction.setPosition(n, s)
                    }
                }
            }
        },
        {
            ...
            value: function(t) {
                ...
                t) if (Object.prototype.hasOwnProperty.call(t, e)) {
                    var i, o = ir(t[e]);
                    o = this._indexArrayToNodes(o),
                    Hf(i = this.direction).call(i, o);
                    for (var n = 0,
                    r = 0; r < o.length; r++) {
                        var s = o[r];
        ...
        },
        {
            ...
            value: function(t) {
                var e = this,
                i = [];
                return Hr(t.edges, (function(t) {
                    var o; - 1 !== On(o = e.body.edgeIndices).call(o, t.id) && i.push(t)
                })),
                i
            }
        },
        {
            ...
            value: function() {
                var t = this,
                e = {};
                Hr(this.body.nodeIndices, (function(i) {
        ...
        },
        {
            ...
            value: function() {
                ...
                i = this._getHubSizes(), o = function(o) {
                    var n = i[o];
                    if (0 === n) return "break";
                    Hr(t.body.nodeIndices, (function(i) {
                        var o = t.body.nodes[i];
        ...
        },
        {
            ...
            value: function() {
                ...
                this._crawlNetwork((function(e, i, o) {
                    ...
                    var r = (Iu.cloneOptions(e, "node"), Iu.cloneOptions(i, "node"), void Iu.cloneOptions(o, "edge"));
        ...
        },
        {
            ...
            value: function() {
                var t, e = this,
                i = zf(t = this.body.nodeIndices).call(t, (function(t, i) {
                ...
                "roots" === this.options.hierarchical.shakeTowards ? this.hierarchical.levels = function(t) {
                    return ip((function(e) {
                        var i, o;
                        return Qf(i = pn(o = e.edges).call(o, (function(e) {
                            return t.has(e.toId)
                        }))).call(i, (function(t) {
                            return t.from === e
                        }))
        ...
        },
        {
            ...
            value: function() {
                ...
                n = function i(n, r) {
                    if (void 0 === o[n.id]) {
                        var s;
                        t.hierarchical.setTreeIndex(n, r),
                        o[n.id] = !0;
                        for (var a = t._getActiveEdges(n), h = 0; h < a.length; h++) {
                            var d = a[h]; ! 0 === d.connected && (s = d.toId == n.id ? d.from: d.to, n.id != s.id && (e(n, s, d), i(s, r)))
                        }
                    }
                };
                if (void 0 === i) for (var r = 0,
                s = 0; s < this.body.nodeIndices.length; s++) {
        ...
        },
        {
            ...
            value: function() {
                ...
                this.direction = t ? new Uf(this) : new Yf(this)
            }
        },
        {
    ...
    function rp(t, e) {
        ...
        if (void 0 === wr || null == ro(t)) {
            if (dr(t) || (i = function(t, e) {
                ...
                "Object" === o && t.constructor && (o = t.constructor.name);
                if ("Map" === o || "Set" === o) return mo(t);
                if ("Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return sp(t, e)
            } (t)) || e && t && "number" == typeof t.length) {
                i && (t = i);
                var o = 0,
                n = function() {};
    ...
    function sp(t, e) { (null == e || e > t.length) && (e = t.length);
        for (var i = 0,
        o = new Array(e); i < e; i++) o[i] = t[i];
        return o
    }
    var ap = function() {
        function t(e, i, o, n) {
            ...
            this.body.emitter.on("_dataChanged", Q(r = this._restore).call(r, this)),
            this.body.emitter.on("_resetData", Q(s = this._restore).call(s, this))
        }
        return od(t, [{
            key: "_restore",
            value: function() { ! 1 !== this.inMode && (!0 === this.options.initiallyActive ? this.enableEditMode() : this.disableEditMode())
            }
        },
        {
            key: "setOptions",
            value: function(t, e, i) {
                void 0 !== e && (void 0 !== e.locale ? this.options.locale = e.locale: this.options.locale = i.locale, void 0 !== e.locales ? this.options.locales = e.locales: this.options.locales = i.locales),
                void 0 !== t && ("boolean" == typeof t ? this.options.enabled = t: (this.options.enabled = !0, Ar(this.options, t)), !0 === this.options.initiallyActive && (this.editMode = !0), this._setup())
            }
        },
        {
            key: "toggleEditMode",
            value: function() { ! 0 === this.editMode ? this.disableEditMode() : this.enableEditMode()
            }
        },
        {
            key: "enableEditMode",
            value: function() {
                this.editMode = !0,
                this._clean(),
                !0 === this.guiEnabled && (this.manipulationDiv.style.display = "block", this.closeDiv.style.display = "block", this.editModeDiv.style.display = "none", this.showManipulatorToolbar())
            }
        },
        {
            key: "disableEditMode",
            value: function() {
                this.editMode = !1,
                this._clean(),
                !0 === this.guiEnabled && (this.manipulationDiv.style.display = "none", this.closeDiv.style.display = "none", this.editModeDiv.style.display = "block", this._createEditButton())
            }
        },
        {
            ...
            value: function() {
                ...
                !0 === this.guiEnabled) {
                    ...
                    s = !1; ! 1 !== this.options.addNode && (this._createAddNodeButton(r), s = !0),
                    !1 !== this.options.addEdge && (!0 === s ? this._createSeperator(1) : s = !0, this._createAddEdgeButton(r)),
                    1 === i && "function" == typeof this.options.editNode ? (!0 === s ? this._createSeperator(2) : s = !0, this._createEditNodeButton(r)) : 1 === o && 0 === i && !1 !== this.options.editEdge && (!0 === s ? this._createSeperator(3) : s = !0, this._createEditEdgeButton(r)),
                    0 !== n && (i > 0 && !1 !== this.options.deleteNode || 0 === i && !1 !== this.options.deleteEdge) && (!0 === s && this._createSeperator(4), this._createDeleteButton(r)),
                    this._bindElementEvents(this.closeDiv, Q(t = this.toggleEditMode).call(t, this)),
                    this._temporaryBindEvent("select", Q(e = this.showManipulatorToolbar).call(e, this))
                }
                this.body.emitter.emit("_redraw")
            }
        },
        {
            ...
            value: function() {
                ...
                if (!0 !== this.editMode && this.enableEditMode(), this._clean(), this.inMode = "addNode", !0 === this.guiEnabled) {
                    ...
                    this._bindElementEvents(this.closeDiv, Q(e = this.toggleEditMode).call(e, this))
                }
                this._temporaryBindEvent("click", Q(t = this._performAddNode).call(t, this))
            }
        },
        {
            key: "editNode",
            value: function() {
                var t = this; ! 0 !== this.editMode && this.enableEditMode(),
                this._clean();
        ...
        },
        {
            ...
            value: function() {
                ...
                if (!0 !== this.editMode && this.enableEditMode(), this._clean(), this.inMode = "addEdge", !0 === this.guiEnabled) {
                    ...
                    this._bindElementEvents(this.closeDiv, Q(r = this.toggleEditMode).call(r, this))
                }
                this._temporaryBindUI("onTouch", Q(t = this._handleConnect).call(t, this)),
                this._temporaryBindUI("onDragEnd", Q(e = this._finishConnect).call(e, this)),
                this._temporaryBindUI("onDrag", Q(i = this._dragControlNode).call(i, this)),
                this._temporaryBindUI("onRelease", Q(o = this._finishConnect).call(o, this)),
                this._temporaryBindUI("onDragStart", Q(n = this._dragStartEdge).call(n, this)),
        ...
        },
        {
            key: "editEdgeMode",
            value: function() {
                if (!0 !== this.editMode && this.enableEditMode(), this._clean(), this.inMode = "editEdge", "object" !== cr(this.options.editEdge) || "function" != typeof this.options.editEdge.editWithoutDrag || (this.edgeBeingEditedId = this.selectionHandler.getSelectedEdgeIds()[0], void 0 === this.edgeBeingEditedId)) {
                    ...
                    if (this.edgeBeingEditedId = this.selectionHandler.getSelectedEdgeIds()[0], void 0 !== this.edgeBeingEditedId) {
                        var i, o, n, r, s = this.body.edges[this.edgeBeingEditedId],
                        ...
                        this._temporaryBindUI("onTouch", Q(i = this._controlNodeTouch).call(i, this)),
                        this._temporaryBindUI("onTap", (function() {})),
                        this._temporaryBindUI("onHold", (function() {})),
                        this._temporaryBindUI("onDragStart", Q(o = this._controlNodeDragStart).call(o, this)),
                        this._temporaryBindUI("onDrag", Q(n = this._controlNodeDrag).call(n, this)),
                        this._temporaryBindUI("onDragEnd", Q(r = this._controlNodeDragEnd).call(r, this)),
                        this._temporaryBindUI("onMouseMove", (function() {})),
                        this._temporaryBindEvent("beforeDrawing", (function(t) {
                            var e = s.edgeType.findBorderPositions(t); ! 1 === a.selected && (a.x = e.from.x, a.y = e.from.y),
        ...
        {
            key: "_setup",
            value: function() { ! 0 === this.options.enabled ? (this.guiEnabled = !0, this._createWrappers(), !1 === this.editMode ? this._createEditButton() : this.showManipulatorToolbar()) : (this._removeManipulationDOM(), this.guiEnabled = !1)
            }
        },
        {
            key: "_createWrappers",
            value: function() {
                var t, e; (void 0 === this.manipulationDiv && (this.manipulationDiv = document.createElement("div"), this.manipulationDiv.className = "vis-manipulation", !0 === this.editMode ? this.manipulationDiv.style.display = "block": this.manipulationDiv.style.display = "none", this.canvas.frame.appendChild(this.manipulationDiv)), void 0 === this.editModeDiv && (this.editModeDiv = document.createElement("div"), this.editModeDiv.className = "vis-edit-mode", !0 === this.editMode ? this.editModeDiv.style.display = "none": this.editModeDiv.style.display = "block", this.canvas.frame.appendChild(this.editModeDiv)), void 0 === this.closeDiv) && (this.closeDiv = document.createElement("button"), this.closeDiv.className = "vis-close", this.closeDiv.setAttribute("aria-label", null !== (t = null === (e = this.options.locales[this.options.locale]) || void 0 === e ? void 0 : e.close) && void 0 !== t ? t: this.options.locales.en.close), this.closeDiv.style.display = this.manipulationDiv.style.display, this.canvas.frame.appendChild(this.closeDiv))
            }
        },
        {
        ...
        },
        {
            ...
            value: function() {
                ...
                this._bindElementEvents(i, Q(t = this.toggleEditMode).call(t, this))
            }
        },
        {
            key: "_clean",
            value: function() {
                this.inMode = !1,
                !0 === this.guiEnabled && (Dr(this.editModeDiv), Dr(this.manipulationDiv), this._cleanupDOMEventListeners()),
        ...
        },
        {
            ...
            value: function() {
                var t, e, i = rp(ls(t = this._domEventListenerCleanupQueue).call(t, 0));
                try {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                this._bindElementEvents(i, Q(e = this.addNodeMode).call(e, this))
            }
        },
        {
            ...
            value: function(t) {
                ...
                this.manipulationDiv.appendChild(i),
                this._bindElementEvents(i, Q(e = this.addEdgeMode).call(e, this))
            }
        },
        {
            ...
            value: function(t) {
                ...
                this.manipulationDiv.appendChild(i),
                this._bindElementEvents(i, Q(e = this.editNode).call(e, this))
            }
        },
        {
            ...
            value: function(t) {
                ...
                this.manipulationDiv.appendChild(i),
                this._bindElementEvents(i, Q(e = this.editEdgeMode).call(e, this))
            }
        },
        {
            ...
            value: function(t) {
                ...
                this._bindElementEvents(o, Q(e = this.deleteSelected).call(e, this))
            }
        },
        {
            ...
            value: function(t) {
                ...
                this.manipulationDiv.appendChild(i),
                this._bindElementEvents(i, Q(e = this.showManipulatorToolbar).call(e, this))
            }
        },
        {
            key: "_createButton",
        ...
        },
        {
            ...
            value: function(t, e) {
                if (void 0 === this.body.eventListeners[t]) throw new Error("This UI function does not exist. Typo? You tried: " + t + " possible are: " + vc(ir(this.body.eventListeners)));
        ...
        },
        {
            ...
            value: function() {
                for (var t = 0; t < this.temporaryIds.edges.length; t++) {
                    ...
                    if ( - 1 !== o) ls(i = this.body.edgeIndices).call(i, o, 1)
                }
                for (var n = 0; n < this.temporaryIds.nodes.length; n++) {
                    ...
                    if ( - 1 !== a) ls(s = this.body.nodeIndices).call(s, a, 1)
                }
                this.temporaryIds = {
                    nodes: [],
                    edges: []
        ...
        },
        {
            ...
            value: function() {
                ...
                s = o.isOverlappingWith(e); ! 0 === r ? (this.selectedControlNode = i, n.edgeType.from = i) : !0 === s && (this.selectedControlNode = o, n.edgeType.to = o),
        ...
        },
        {
            ...
            value: function(t) {
                ...
                void 0 !== this.selectedControlNode ? (this.selectedControlNode.x = i.x, this.selectedControlNode.y = i.y) : this.interactionHandler.onDrag(t),
                this.body.emitter.emit("_redraw")
            }
        },
        {
            ...
            value: function(t) {
                ...
                if (void 0 !== this.selectedControlNode) {
                    ...
                    if (void 0 !== r && void 0 !== this.selectedControlNode) if (!0 === r.isCluster) alert(this.options.locales[this.options.locale].createEdgeError || this.options.locales.en.createEdgeError);
                    else {
        ...
        },
        {
            ...
            value: function(t) {
                if ((new Date).valueOf() - this.touchTime > 100) {
                    ...
                    if (void 0 !== i) if (!0 === i.isCluster) alert(this.options.locales[this.options.locale].createEdgeError || this.options.locales.en.createEdgeError);
                    else {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                this._cleanupTemporaryNodesAndEdges(),
                void 0 !== r && (!0 === r.isCluster ? alert(this.options.locales[this.options.locale].createEdgeError || this.options.locales.en.createEdgeError) : void 0 !== this.body.nodes[o] && void 0 !== this.body.nodes[r.id] && this._performAddEdge(o, r.id)),
                t.controlEdge = {
                    from: o,
                    to: r ? r.id: void 0
                },
        ...
        },
        {
            ...
            value: function(t) {
                ...
                } else this.body.data.nodes.getDataSet().add(i),
                this.showManipulatorToolbar()
            }
        },
        {
            ...
            value: function(t, e) {
                ...
                } else this.body.data.edges.getDataSet().add(o),
                this.selectionHandler.unselectAll(),
                this.showManipulatorToolbar()
            }
        },
        {
            ...
            value: function(t, e) {
                ...
                if ("object" === cr(n) && (n = n.editWithoutDrag), "function" == typeof n) {
    ...
    dp = function() {
        ...
        },
        {
            key: "_isColorString",
            value: function(t) {
                if ("string" == typeof t) return hp[t]
            }
        },
        {
            key: "setColor",
            value: function(t) {
                ...
                if ("none" !== t) {
                    ...
                    if (void 0 === i) throw new Error("Unknown color passed to the colorPicker. Supported are strings: rgb, hex, rgba. Object: rgb ({r:r,g:g,b:b,[a:a]}). Supplied: " + vc(t));
                    this._setColor(i, e)
                }
            }
        },
        ...
        },
        {
            ...
            value: function() {
                var t = this,
                e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0]; ! 0 === e && (this.previousColor = bt({},
                this.color)),
        ...
        },
        {
            key: "_setColor",
            value: function(t) {
                var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]; ! 0 === e && (this.initialColor = bt({},
                t)),
                this.color = t;
                var i = Yr(t.r, t.g, t.b),
                o = 2 * Math.PI,
                n = this.r * i.s,
        ...
        },
        {
            key: "_setBrightness",
            value: function(t) {
                var e = Yr(this.color.r, this.color.g, this.color.b);
                e.v = t / 100;
                var i = Xr(e.h, e.s, e.v);
                i.a = this.color.a,
                this.color = i,
                this._updatePicker()
            }
        ...
        },
        {
            ...
            value: function() {
                ...
                this.cancelButton.onclick = Q(t = this._hide).call(t, this, !1),
                this.applyButton = document.createElement("div"),
                this.applyButton.className = "vis-button vis-apply",
                this.applyButton.innerText = "apply",
                this.applyButton.onclick = Q(e = this._apply).call(e, this),
                this.saveButton = document.createElement("div"),
                this.saveButton.className = "vis-button vis-save",
                this.saveButton.innerText = "save",
                this.saveButton.onclick = Q(i = this._save).call(i, this),
                this.loadButton = document.createElement("div"),
                this.loadButton.className = "vis-button vis-load",
                this.loadButton.innerText = "load last",
                this.loadButton.onclick = Q(o = this._loadLast).call(o, this),
        ...
        },
        {
            ...
            value: function() {
                ...
                this.drag = {},
                this.pinch = {},
                this.hammer = new $h(this.colorPickerCanvas),
                this.hammer.get("pinch").set({
                    enable: !0
                }),
                Lu(this.hammer, (function(e) {
        ...
        },
        {
            ...
            value: function() {
                if (!1 === this.generated) {
                    ...
                    t.setTransform(this.pixelRatio, 0, 0, this.pixelRatio, 0, 0);
                    var e, i, o, n, r = this.colorPickerCanvas.clientWidth,
                    ...
                    a = Xr(.002777777777777778 * o, n * d, 1),
        ...
        },
        {
            ...
            value: function(t) {
                ...
                u = u < 0 ? u + 1 : u;
                var f = d / this.r,
                p = Yr(this.color.r, this.color.g, this.color.b);
                p.h = u,
                p.s = f;
                var v = Xr(p.h, p.s, p.v);
                v.a = this.color.a,
                this.color = v,
                this.initialColorDiv.style.backgroundColor = "rgba(" + this.initialColor.r + "," + this.initialColor.g + "," + this.initialColor.b + "," + this.initialColor.a + ")",
                this.newColorDiv.style.backgroundColor = "rgba(" + this.color.r + "," + this.color.g + "," + this.color.b + "," + this.color.a + ")"
    ...
    function lp() {
        ...
        return o.appendChild(lp(ur(e).call(e, 1))),
        o
    }
    var cp = function() {
        function t(e, i, o) {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                !0 === this.options.enabled && (this._clean(), void 0 !== this.options.container && (this.container = this.options.container), this._create())
            }
        },
        {
            key: "_create",
            value: function() {
                this._clean(),
                this.changedOptions = [];
                var t = pn(this.options),
                e = 0,
                i = !1;
                for (var o in this.configureOptions) Object.prototype.hasOwnProperty.call(this.configureOptions, o) && (this.allowCreation = !1, i = !1, "function" == typeof t ? i = (i = t(o, [])) || this._handleObject(this.configureOptions[o], [o], !0) : !0 !== t && -1 === On(t).call(t, o) || (i = !0), !1 !== i && (this.allowCreation = !0, e > 0 && this._makeItem([]), this._makeHeader(o), this._handleObject(this.configureOptions[o], [o])), e++);
                this._makeButton(),
                this._push()
            }
        },
        ...
        },
        {
            ...
            value: function(t) {
                if (!0 === this.allowCreation) {
                    ...
                    o = new Array(i > 1 ? i - 1 : 0), n = 1; n < i; n++) o[n - 1] = arguments[n];
                    return qo(o).call(o, (function(t) {
                        e.appendChild(t)
                    })),
        ...
        },
        {
            ...
            value: function(t, e, i) {
                ...
                if (void 0 !== e) {
                    var l = 1.2;
                    e < 0 && e * l < n ? (a.min = Math.ceil(e * l), d = a.min, h = "range increased") : e / l < n && (a.min = Math.ceil(e / l), d = a.min, h = "range increased"),
        ...
        },
        {
            ...
            value: function() {
                ...
                if (void 0 !== this.popupDiv.html) {
                    ...
                    this.popupDiv.hideTimeout = Td((function() {
                        t.popupDiv.html.style.opacity = 0
                    }), 1500),
                    this.popupDiv.deleteTimeout = Td((function() {
                        t._removePopup()
                    }), 1800)
                }
            }
        },
        {
            ...
            value: function(t, e, i) {
                ...
                o.checked = t,
                void 0 !== e && (o.checked = e, e !== t && ("object" === cr(t) ? e !== t.enabled && this.changedOptions.push({
                    path: i,
                    value: e
        ...
        },
        {
            ...
            value: function(t, e, i) {
                ...
                "none" !== (e = void 0 === e ? n: e) ? (r.className = "vis-configuration vis-config-colorBlock", r.style.backgroundColor = e) : r.className = "vis-configuration vis-config-colorBlock none",
                e = void 0 === e ? n: e,
                r.onclick = function() {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                for (var s in t) if (Object.prototype.hasOwnProperty.call(t, s)) {
                    ...
                    var a = t[s],
                    h = Rr(e, s);
                    if ("function" == typeof n && !1 === (o = n(s, e)) && !dr(a) && "string" != typeof a && "boolean" != typeof a && a instanceof Object && (this.allowCreation = !1, o = this._handleObject(a, h, !0), this.allowCreation = !1 === i), !1 !== o) {
                        r = !0;
                        var d = this._getValue(h);
                        if (dr(a)) this._handleArray(a, d, h);
                        else if ("string" == typeof a) this._makeTextInput(a, d, h);
                        else if ("boolean" == typeof a) this._makeCheckbox(a, d, h);
                        else if (a instanceof Object) {
                            var l = !0;
                            if ( - 1 !== On(e).call(e, "physics") && this.moduleOptions.physics.solver !== s && "wind" !== s && (l = !1), !0 === l) if (void 0 !== a.enabled) {
                                var c = Rr(h, "enabled"),
                                u = this._getValue(c);
                                if (!0 === u) {
        ...
        },
        {
            ...
            value: function() {
                ...
                this.optionsContainer.appendChild(lp("pre", "const options = " + vc(t, null, 2)))
            }
        },
        {
            key: "getOptions",
    ...
    vp = "array",
    gp = "object",
    yp = ["arrow", "bar", "box", "circle", "crow", "curve", "diamond", "image", "inv_curve", "inv_triangle", "triangle", "vee"],
    mp = {
        configure: {
            enabled: {
                boolean: fp
    ...
    mp.groups.__any__ = mp.nodes,
    mp.manipulation.controlNodeStyle = mp.nodes;
    var bp = {
        nodes: {
        ...
        return od(t, [{
            ...
            value: function(t, e, i) {
                ...
                for (var h = 0; h < i.length; h++) {
                    var d = n[i[h]]; ! 0 === d.connected && void 0 !== o[d.fromId] && void 0 !== o[d.toId] && (o[d.fromId][d.toId] = 1, o[d.toId][d.fromId] = 1)
                }
                for (var l = e.length,
                c = 0; c < l; c++) for (var u = e[c], f = o[u], p = 0; p < l - 1; p++) for (var v = e[p], g = o[v], y = p + 1; y < l; y++) {
                    var m = e[y],
                    b = o[m],
    ...
    _p = function() {
        ...
        },
        {
            ...
            value: function(t, e) {
                ...
                r = 1,
                s = 0,
                a = Math.max(1e3, Math.min(10 * this.body.nodeIndices.length, 6e3)), h = 5, d = 1e9, l = 0, c = 0, u = 0, f = 0, p = 0; d > n && s < a;) {
                    s += 1;
                    var v = this._getHighestEnergyNode(i),
                    g = Jn(v, 4);
                    for (l = g[0], d = g[1], c = g[2], u = g[3], f = d, p = 0; f > r && p < h;) {
                        p += 1,
                        this._moveNode(l, c, u);
        ...
        },
        {
            key: "_moveNode",
            value: function(t, e, i) {
                for (var o = this.body.nodeIndices,
                n = this.body.nodes,
                r = 0,
                s = 0,
                a = 0,
                h = n[t].x, d = n[t].y, l = this.K_matrix[t], c = this.L_matrix[t], u = 0; u < o.length; u++) {
                    var f = o[u];
                    if (f !== t) {
                        var p = n[f].x,
                        v = n[f].y,
                ...
                for (var o = 0; o < t.length; o++) {
                    for (var n = t[o], r = e[n].x, s = e[n].y, a = 0, h = 0, d = o; d < t.length; d++) {
                        ...
                        if (l !== n) {
                            ...
                            a += this.E_matrix[n][d][0],
                            h += this.E_matrix[n][d][1]
                        }
                    }
                    this.E_sums[n] = [a, h]
                }
        ...
        },
        {
            ...
            value: function(t) {
                for (var e = this.body.nodeIndices,
                i = this.body.nodes,
                o = this.E_matrix[t], n = this.K_matrix[t], r = this.L_matrix[t], s = i[t].x, a = i[t].y, h = 0, d = 0, l = 0; l < e.length; l++) {
                    var c = e[l];
                    if (c !== t) {
                        var u = o[l],
                        f = u[0],
    ...
    function xp(t, e, i) {
        var o, n, r, s, a = this;
        if (! (this instanceof xp)) throw new SyntaxError("Constructor must be called with the new operator");
        this.options = {},
        this.defaultOptions = {
            locale: "en",
            locales: td,
        ...
        this.body = {
            ...
            edgeIndices: [],
            emitter: {
                on: Q(o = this.on).call(o, this),
                off: Q(n = this.off).call(n, this),
                emit: Q(r = this.emit).call(r, this),
                once: Q(s = this.once).call(s, this)
            },
            eventListeners: {
                onTap: function() {},
                onTouch: function() {},
        ...
        this.bindEventListeners(),
        this.images = new rd((function() {
            return a.body.emitter.emit("_requestRedraw")
        })),
        this.groups = new Ed,
        this.canvas = new Wu(this.body),
        this.selectionHandler = new Ef(this.body, this.canvas),
        this.interactionHandler = new $u(this.body, this.canvas, this.selectionHandler),
        this.view = new qu(this.body, this.canvas),
        this.renderer = new Ru(this.body, this.canvas),
        this.physics = new Eu(this.body),
        this.layoutEngine = new np(this.body),
        this.clustering = new Fu(this.body),
        this.manipulation = new ap(this.body, this.canvas, this.selectionHandler, this.interactionHandler),
        this.nodesHandler = new Ec(this.body, this.images, this.groups, this.layoutEngine),
        this.edgesHandler = new uu(this.body, this.images, this.groups),
        this.body.modules.kamadaKawai = new _p(this.body, 150, .05),
    ...
    Ct(xp.prototype),
    xp.prototype.setOptions = function(t) {
        var e = this;
        if (null === t && (t = void 0), void 0 !== t) { ! 0 === mc.validate(t, mp) && console.error("%cErrors have been found in the supplied options object.", yc);
            if (Fr(["locale", "locales", "clickToUse"], this.options, t), void 0 !== t.locale && (t.locale = function(t, e) {
                try {
                    var i = e.split(/[-_ /] / ,
                    2),
                    o = Jn(i, 2),
                    n = o[0],
                    r = o[1],
                    s = null != n ? n.toLowerCase() : null,
                    a = null != r ? r.toUpperCase() : null;
                    if (s && a) {
                        var h, d = s + "-" + a;
                        if (Object.prototype.hasOwnProperty.call(t, d)) return d;
                        console.warn(br(h = "Unknown variant ".concat(a, " of language ")).call(h, s, "."))
                    }
                    if (s) {
                        var l = s;
            ...
            "configure" in t && (this.configurator || (this.configurator = new cp(this, this.body.container, bp, this.canvas.pixelRatio)), this.configurator.setOptions(t.configure)),
            this.configurator && !0 === this.configurator.options.enabled) {
                ...
                Ar(i.nodes, this.nodesHandler.options),
                Ar(i.edges, this.edgesHandler.options),
                Ar(i.layout, this.layoutEngine.options),
                Ar(i.interaction, this.selectionHandler.options),
                Ar(i.interaction, this.renderer.options),
                Ar(i.interaction, this.interactionHandler.options),
                Ar(i.manipulation, this.manipulation.options),
                Ar(i.physics, this.physics.options),
                Ar(i.global, this.canvas.options),
                Ar(i.global, this.options),
                this.configurator.setModuleOptions(i)
            }
            void 0 !== t.clickToUse ? !0 === t.clickToUse ? void 0 === this.activator && (this.activator = new Jh(this.canvas.frame), this.activator.on("change", (function() {
                e.body.emitter.emit("activate")
            }))) : (void 0 !== this.activator && (this.activator.destroy(), delete this.activator), this.body.emitter.emit("activate")) : this.body.emitter.emit("activate"),
            this.canvas.setSize(),
            this.body.emitter.emit("startSimulation")
        }
    },
    xp.prototype._updateVisibleIndices = function() {
        var t = this.body.nodes,
        e = this.body.edges;
        ...
        for (var o in e) if (Object.prototype.hasOwnProperty.call(e, o)) {
            ...
            r = t[n.fromId],
            s = t[n.toId],
            a = void 0 !== r && void 0 !== s; ! this.clustering._isClusteredEdge(o) && !1 === n.options.hidden && a && !1 === r.options.hidden && !1 === s.options.hidden && this.body.edgeIndices.push(n.id)
        }
    },
    xp.prototype.bindEventListeners = function() {
        var t = this;
        this.body.emitter.on("_dataChanged", (function() {
    ...
    xp.prototype.setData = function(t) {
    ...
    xp.prototype.destroy = function() {
        ...
        Dr(this.body.container)
    },
    xp.prototype._updateValueRange = function(t) {
        var e, i = void 0,
        o = void 0,
        n = 0;
    ...
    xp.prototype.isActive = function() {
        return ! this.activator || this.activator.active
    },
    xp.prototype.setSize = function() {
        return this.canvas.setSize.apply(this.canvas, arguments)
    },
    xp.prototype.canvasToDOM = function() {
        return this.canvas.canvasToDOM.apply(this.canvas, arguments)
    },
    xp.prototype.DOMtoCanvas = function() {
        return this.canvas.DOMtoCanvas.apply(this.canvas, arguments)
    },
    xp.prototype.findNode = function() {
        return this.clustering.findNode.apply(this.clustering, arguments)
    },
    xp.prototype.isCluster = function() {
        return this.clustering.isCluster.apply(this.clustering, arguments)
    },
    xp.prototype.openCluster = function() {
        return this.clustering.openCluster.apply(this.clustering, arguments)
    },
    xp.prototype.cluster = function() {
        return this.clustering.cluster.apply(this.clustering, arguments)
    },
    xp.prototype.getNodesInCluster = function() {
        return this.clustering.getNodesInCluster.apply(this.clustering, arguments)
    },
    xp.prototype.clusterByConnection = function() {
        return this.clustering.clusterByConnection.apply(this.clustering, arguments)
    },
    xp.prototype.clusterByHubsize = function() {
        return this.clustering.clusterByHubsize.apply(this.clustering, arguments)
    },
    xp.prototype.updateClusteredNode = function() {
        return this.clustering.updateClusteredNode.apply(this.clustering, arguments)
    },
    xp.prototype.getClusteredEdges = function() {
        return this.clustering.getClusteredEdges.apply(this.clustering, arguments)
    },
    xp.prototype.getBaseEdge = function() {
        return this.clustering.getBaseEdge.apply(this.clustering, arguments)
    },
    xp.prototype.getBaseEdges = function() {
        return this.clustering.getBaseEdges.apply(this.clustering, arguments)
    },
    xp.prototype.updateEdge = function() {
        return this.clustering.updateEdge.apply(this.clustering, arguments)
    },
    xp.prototype.clusterOutliers = function() {
        return this.clustering.clusterOutliers.apply(this.clustering, arguments)
    },
    xp.prototype.getSeed = function() {
        return this.layoutEngine.getSeed.apply(this.layoutEngine, arguments)
    },
    xp.prototype.enableEditMode = function() {
        return this.manipulation.enableEditMode.apply(this.manipulation, arguments)
    },
    xp.prototype.disableEditMode = function() {
        return this.manipulation.disableEditMode.apply(this.manipulation, arguments)
    },
    xp.prototype.addNodeMode = function() {
        return this.manipulation.addNodeMode.apply(this.manipulation, arguments)
    },
    xp.prototype.editNode = function() {
        return this.manipulation.editNode.apply(this.manipulation, arguments)
    },
    xp.prototype.editNodeMode = function() {
    ...
    xp.prototype.addEdgeMode = function() {
        return this.manipulation.addEdgeMode.apply(this.manipulation, arguments)
    },
    xp.prototype.editEdgeMode = function() {
        return this.manipulation.editEdgeMode.apply(this.manipulation, arguments)
    },
    xp.prototype.deleteSelected = function() {
        return this.manipulation.deleteSelected.apply(this.manipulation, arguments)
    },
    xp.prototype.getPositions = function() {
        return this.nodesHandler.getPositions.apply(this.nodesHandler, arguments)
    },
    xp.prototype.getPosition = function() {
        return this.nodesHandler.getPosition.apply(this.nodesHandler, arguments)
    },
    xp.prototype.storePositions = function() {
        return this.nodesHandler.storePositions.apply(this.nodesHandler, arguments)
    },
    xp.prototype.moveNode = function() {
        return this.nodesHandler.moveNode.apply(this.nodesHandler, arguments)
    },
    xp.prototype.getBoundingBox = function() {
        return this.nodesHandler.getBoundingBox.apply(this.nodesHandler, arguments)
    },
    xp.prototype.getConnectedNodes = function(t) {
    ...
    xp.prototype.getConnectedEdges = function() {
        return this.nodesHandler.getConnectedEdges.apply(this.nodesHandler, arguments)
    },
    xp.prototype.startSimulation = function() {
        return this.physics.startSimulation.apply(this.physics, arguments)
    },
    xp.prototype.stopSimulation = function() {
        return this.physics.stopSimulation.apply(this.physics, arguments)
    },
    xp.prototype.stabilize = function() {
        return this.physics.stabilize.apply(this.physics, arguments)
    },
    xp.prototype.getSelection = function() {
        return this.selectionHandler.getSelection.apply(this.selectionHandler, arguments)
    },
    xp.prototype.setSelection = function() {
        return this.selectionHandler.setSelection.apply(this.selectionHandler, arguments)
    },
    xp.prototype.getSelectedNodes = function() {
        return this.selectionHandler.getSelectedNodeIds.apply(this.selectionHandler, arguments)
    },
    xp.prototype.getSelectedEdges = function() {
        return this.selectionHandler.getSelectedEdgeIds.apply(this.selectionHandler, arguments)
    },
    xp.prototype.getNodeAt = function() {
        var t = this.selectionHandler.getNodeAt.apply(this.selectionHandler, arguments);
        return void 0 !== t && void 0 !== t.id ? t.id: t
    },
    xp.prototype.getEdgeAt = function() {
        var t = this.selectionHandler.getEdgeAt.apply(this.selectionHandler, arguments);
        return void 0 !== t && void 0 !== t.id ? t.id: t
    },
    xp.prototype.selectNodes = function() {
        return this.selectionHandler.selectNodes.apply(this.selectionHandler, arguments)
    },
    xp.prototype.selectEdges = function() {
        return this.selectionHandler.selectEdges.apply(this.selectionHandler, arguments)
    },
    xp.prototype.unselectAll = function() {
        this.selectionHandler.unselectAll.apply(this.selectionHandler, arguments),
        this.redraw()
    },
    xp.prototype.redraw = function() {
        return this.renderer.redraw.apply(this.renderer, arguments)
    },
    xp.prototype.getScale = function() {
        return this.view.getScale.apply(this.view, arguments)
    },
    xp.prototype.getViewPosition = function() {
        return this.view.getViewPosition.apply(this.view, arguments)
    },
    xp.prototype.fit = function() {
        return this.view.fit.apply(this.view, arguments)
    },
    xp.prototype.moveTo = function() {
        return this.view.moveTo.apply(this.view, arguments)
    },
    xp.prototype.focus = function() {
        return this.view.focus.apply(this.view, arguments)
    },
    xp.prototype.releaseNode = function() {
        return this.view.releaseNode.apply(this.view, arguments)
    },
    xp.prototype.getOptionsFromConfigurator = function() {
        var t = {};
        return this.configurator && (t = this.configurator.getOptions.apply(this.configurator)),
        t
    };
    var Ep = Js; t.Network = xp, t.NetworkImages = rd, t.networkDOTParser = ta, t.networkGephiParser = ia, t.networkOptions = wp, t.parseDOTNetwork = Ep, t.parseGephiNetwork = ea, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));
